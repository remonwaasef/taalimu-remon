    ...
    <div class="container mx-auto px-4 lg:px-8">
        ...
        <div class="text-center mb-12 lg:mb-16">
            <h2 class="text-3xl lg:text-4xl font-bold text-foreground mb-4">
                <?php echo e(__('landing.pain_points.title_prefix')); ?> <span class="gradient-text"><?php echo e(__('landing.pain_points.title_highlight')); ?></span><?php echo e(__('landing.pain_points.title_suffix')); ?>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            >
                ...
                <h3 class="text-xl font-semibold text-foreground mb-2">
                    <?php echo e(__('landing.pain_points.revenue_lost.title')); ?>

                </h3>

                <!-- Description -->
                <p class="text-muted-foreground">
                    <?php echo e(__('landing.pain_points.revenue_lost.description')); ?>
            ...
            >
                ...
                <!-- Title -->
                <h3 class="text-xl font-semibold text-foreground mb-2">
                    <?php echo e(__('landing.pain_points.time_wasted.title')); ?>

                </h3>

                <!-- Description -->
                <p class="text-muted-foreground">
                    <?php echo e(__('landing.pain_points.time_wasted.description')); ?>
            ...
            >
                ...
                <!-- Title -->
                <h3 class="text-xl font-semibold text-foreground mb-2">
                    <?php echo e(__('landing.pain_points.visibility.title')); ?>

                </h3>

                <!-- Description -->
                <p class="text-muted-foreground">
                    <?php echo e(__('landing.pain_points.visibility.description')); ?>
            ...
            >
                ...
                <!-- Title -->
                <h3 class="text-xl font-semibold text-foreground mb-2">
                    <?php echo e(__('landing.pain_points.scheduling_chaos.title')); ?>

                </h3>

                <!-- Description -->
                <p class="text-muted-foreground">
                    <?php echo e(__('landing.pain_points.scheduling_chaos.description')); ?>
        ...
        <div class="text-center mt-12">
            <p class="text-lg text-foreground">
                <?php echo __('landing.pain_points.cta'); ?>
