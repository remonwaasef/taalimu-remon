    ...
    <div class="w-full max-w-xl bg-white rounded-[2.5rem] shadow-2xl shadow-blue-900/5 overflow-hidden border border-slate-100/50 animate-fade-in-up md:backdrop-blur-xl relative">
        ...
        <div class="bg-white p-8 lg:p-12 pb-0">
            ...
            <div class="mb-10" x-show="currentStep === 1">
                <a href="<?php echo e(route('auth.google')); ?>" class="w-full flex items-center justify-center gap-4 py-4 px-6 border-2 border-slate-100 rounded-3xl shadow-sm text-base font-black text-slate-700 bg-white hover:bg-slate-50 hover:border-brand-secondary/20 transition-all group">
                ...
                <div class="relative my-8 px-8">
                    ...
                    <div class="relative flex justify-center text-[10px] uppercase"><span class="bg-white px-4 text-slate-300 font-black tracking-[0.2em]"><?php echo e(__('auth.register.or') ?? 'OR'); ?></span></div>
                </div>
            </div>
        </div>
        ...
        <div class="p-8 lg:p-12 pt-0">
            <form action="<?php echo e(route('register.submit')); ?>" method="POST" class="space-y-6">
                ...
                <div x-show="currentStep === 1" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-6">
                    ...
                    <div class="pt-6">
                        <button type="button" @click="nextStep()"
                            ...
                            <span class="text-xl font-black font-arabic"><?php echo e(app()->isLocale('ar') ? 'استمرار' : 'Continue'); ?></span>
                ...
                <div x-show="currentStep === 2" x-cloak style="display: none;" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-6">
                    <div class="space-y-1.5">
                        <label class="text-[13px] font-black text-slate-400 px-1 font-arabic uppercase tracking-wide"><?php echo e(__('auth.register.full_name')); ?></label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-1.5">
                            <label class="text-[13px] font-black text-slate-400 px-1 font-arabic uppercase tracking-wide"><?php echo e(__('auth.register.email')); ?></label>
                    ...
                    <div class="space-y-1.5">
                        <div class="flex justify-between items-center px-1">
                            <label class="text-[13px] font-black text-slate-400 font-arabic uppercase tracking-wide"><?php echo e(__('auth.register.password')); ?></label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <input :type="showPassword ? 'text' : 'password'" name="password_confirmation" x-model="password_confirmation" class="w-full h-14 px-5 bg-slate-50/50 border-2 border-slate-100 rounded-2xl text-base font-bold focus:outline-none focus:bg-white focus:ring-4 focus:ring-brand-secondary/5 focus:border-brand-secondary transition-all shadow-inner" :class="password_confirmation.length > 0 && !isPasswordMatch ? 'border-red-300 bg-red-50' : ''" placeholder="<?php echo e(__('auth.register.confirm_password')); ?>" :required="currentStep === 2">
                        </div>
                    </div>
                    ...
                    <div class="pt-6 flex flex-col sm:flex-row gap-4">
                        ...
                        <button type="submit" :disabled="password.length > 0 && !isPasswordMatch"
                            ...
                            <?php echo e(__('auth.register.cta_main')); ?>
