    ...
    <div class="container relative mx-auto px-4 lg:px-8">
        ...
        <div class="text-center mb-12 lg:mb-20">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5 border border-primary/20 mb-6">
                <span class="text-sm font-medium text-primary"><?php echo e(__('landing.automation.badge')); ?></span>
            </div>
            <h2 class="text-3xl lg:text-4xl font-bold text-foreground mb-4">
                <?php echo e(__('landing.automation.title_prefix')); ?> <span class="gradient-text"><?php echo e(\App\Models\SiteSetting::get('site_name', __('landing.automation.title_highlight'))); ?></span>
            </h2>
        ...
        <div class="grid md:grid-cols-3 gap-8 lg:gap-12 relative">
            ...
            >
                ...
                <h3 class="text-xl font-semibold text-foreground mb-3">
                    <?php echo e(__('landing.automation.step1.title')); ?>

                </h3>
                <p class="text-muted-foreground max-w-xs mx-auto mb-8">
                    <?php echo e(__('landing.automation.step1.description')); ?>
                ...
                <div class="relative mx-auto max-w-[280px] rounded-2xl overflow-hidden border border-border shadow-2xl group-hover:-translate-y-2 transition-transform duration-500 bg-card">
                    <img src="<?php echo e(asset('images/automation/step1.webp')); ?>" alt="<?php echo e(__('landing.automation.step1.title')); ?>" class="w-full h-auto opacity-90 group-hover:opacity-100 transition-opacity" loading="lazy" decoding="async" width="600" height="400">
                    <!-- Glass overlay -->
            ...
            >
                ...
                <!-- Content -->
                <h3 class="text-xl font-semibold text-foreground mb-3">
                    <?php echo e(__('landing.automation.step2.title')); ?>

                </h3>
                <p class="text-muted-foreground max-w-xs mx-auto mb-8">
                    <?php echo e(__('landing.automation.step2.description')); ?>

                </p>

                <!-- Visual -->
                <div class="relative mx-auto max-w-[280px] rounded-2xl overflow-hidden border border-border shadow-2xl group-hover:-translate-y-2 transition-transform duration-500 bg-card">
                    <img src="<?php echo e(asset('images/automation/step2.webp')); ?>" alt="<?php echo e(__('landing.automation.step2.title')); ?>" class="w-full h-auto opacity-90 group-hover:opacity-100 transition-opacity" loading="lazy" decoding="async" width="600" height="400">
                    <!-- Glass overlay -->
                    <div class="absolute inset-0 bg-gradient-to-t from-background/40 to-transparent pointer-events-none"></div>
                </div>
            ...
            >
                ...
                <!-- Content -->
                <h3 class="text-xl font-semibold text-foreground mb-3">
                    <?php echo e(__('landing.automation.step3.title')); ?>

                </h3>
                <p class="text-muted-foreground max-w-xs mx-auto mb-8">
                    <?php echo e(__('landing.automation.step3.description')); ?>

                </p>

                <!-- Visual -->
                <div class="relative mx-auto max-w-[280px] rounded-2xl overflow-hidden border border-border shadow-2xl group-hover:-translate-y-2 transition-transform duration-500 bg-card">
                    <img src="<?php echo e(asset('images/automation/step3.webp')); ?>" alt="<?php echo e(__('landing.automation.step3.title')); ?>" class="w-full h-auto opacity-90 group-hover:opacity-100 transition-opacity" loading="lazy" decoding="async" width="600" height="400">
                    <!-- Glass overlay -->
                    <div class="absolute inset-0 bg-gradient-to-t from-background/40 to-transparent pointer-events-none"></div>
                </div>
            </div>
