...
<?php $__env->startSection('content'); ?>
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold text-dark mb-1"><?php echo e(__('center::sidebar.schedules')); ?></h2>
            <p class="text-muted mb-0"><?php echo e(__('center::students.weekly_schedule_overview')); ?></p>
        </div>
        <a href="<?php echo e(route('center.schedules.create')); ?>" class="btn btn-primary rounded-pill px-4 shadow-sm">
            <i class="fas fa-plus me-2"></i> <?php echo e(__('center::students.add_new_schedule')); ?>
                                        ...
                                        <div class="d-flex justify-content-between align-items-start mb-3">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end border-0 shadow-sm">
                                                    <li><a class="dropdown-item" href="<?php echo e(route('center.schedules.edit', $schedule)); ?>"><i class="fas fa-edit me-2"></i> <?php echo e(__('center::students.edit')); ?></a></li>
                                                    <li><a class="dropdown-item" href="<?php echo e(route('center.attendance.qr', $schedule->id)); ?>"><i class="fas fa-qrcode me-2"></i> <?php echo e(__('center::students.qr_code')); ?></a></li>
                                                    <li><hr class="dropdown-divider"></li>
                                                    <li>
                                                        <form action="<?php echo e(route('center.schedules.destroy', $schedule)); ?>" method="POST" onsubmit="return confirm('<?php echo e(__('center::students.confirm_delete')); ?>')">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('DELETE'); ?>
                                                            <button class="dropdown-item text-danger"><i class="fas fa-trash me-2"></i> <?php echo e(__('center::students.delete')); ?></button>
                                                        </form>
                                                    </li>
                                                </ul>
                                            </div>
        ...
        <?php if($groupedSchedules->isEmpty()): ?>
            <div class="col-12">
                <div class="card border-0 shadow-sm rounded-4 text-center p-5">
                    ...
                    <h4 class="text-muted"><?php echo e(__('center::students.no_schedules_found')); ?></h4>
                    <div class="mt-3">
                        <a href="<?php echo e(route('center.schedules.create')); ?>" class="btn btn-primary rounded-pill px-4">
                            <?php echo e(__('center::students.add_your_first_schedule')); ?>
