...
<?php $__env->startSection('title', __('admin.roles.create_new')); ?>
<?php $__env->startSection('page-title', __('admin.roles.create_new')); ?>
...
unset($__errorArgs, $__bag); ?>" required value="<?php echo e(old('name')); ?>" placeholder="مثال: accountant">
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 text-md-end mt-3 mt-md-0">
                            <button type="submit" class="btn btn-primary rounded-pill px-4 me-2">
                                <i class="fas fa-plus me-2"></i> <?php echo e(__('admin.save_changes')); ?>
                                ...
                                <div class="d-flex flex-column gap-2">
                                    <?php $__currentLoopData = $perms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="form-check form-switch custom-switch p-0 d-flex justify-content-between align-items-center flex-row-reverse">
                                            <input class="form-check-input ms-0" type="checkbox" id="perm_<?php echo e($permission->id); ?>" name="permissions[]" value="<?php echo e($permission->name); ?>">
