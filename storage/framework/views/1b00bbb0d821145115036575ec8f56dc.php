<?php $__env->startSection('page-title', __('instructor::groups.create_new')); ?>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-header bg-white border-0 pt-4 px-4">
                    <h4 class="fw-bold mb-0"><?php echo e(__('instructor::groups.group_details_new')); ?></h4>
                    <p class="text-muted small"><?php echo e(__('instructor::groups.group_hint')); ?></p>
                </div>
                <div class="card-body p-4">
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('instructor.groups.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="row g-4">
                            <div class="col-12">
                                <label class="form-label fw-bold"><?php echo e(__('instructor::groups.group_name_placeholder_label')); ?></label>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('title')); ?>" required placeholder="<?php echo e(__('instructor::groups.group_name_input_placeholder')); ?>">
...
unset($__errorArgs, $__bag); ?>" rows="3" placeholder="<?php echo e(__('instructor::groups.group_description_placeholder')); ?>"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('price')); ?>" required step="0.01" min="0" placeholder="0.00">
                                    <span class="input-group-text rounded-end-3 bg-light border-start-0"><?php echo e(app('tenant')->settings['currency'] ?? __('instructor::groups.currency')); ?></span>
                                </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('sessions_count')); ?>" required min="1" placeholder="<?php echo e(__('instructor::groups.sessions_placeholder')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="d-flex gap-3 mt-4">
                                    <button type="submit" class="btn btn-primary rounded-pill px-5 py-2 fw-bold shadow-sm border-0" style="background: var(--primary-color);">
                                        <i class="fas fa-save me-2"></i> <?php echo e(__('instructor::groups.save_group')); ?>
