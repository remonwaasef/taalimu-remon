<nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
  <div class="container-fluid navbar-inner">
    <a href="<?php echo e(route('center.dashboard', ['tenant' => $tenant->domain ?? 'center'])); ?>" class="navbar-brand">
       <?php if($tenant->logo): ?>
            <img src="<?php echo e(asset('storage/' . $tenant->logo)); ?>" class="rounded-3 shadow-sm p-1" style="max-height: 45px; max-width: 100%;">
        <?php else: ?>
        ...
        <?php endif; ?>
      <h4 class="logo-title ms-2 text-truncate" style="max-width: 150px;"><?php echo e($tenant->name ?? __('sidebar.center_name')); ?></h4>
    </a>
        ...
        <?php if(auth()->guard()->check()): ?>
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view sales')): ?>
            ...
            <li class="nav-item me-3">
              <a href="<?php echo e(route('center.sales.overdue', ['tenant' => $tenant->domain ?? 'center'])); ?>" class="btn btn-outline-danger d-flex align-items-center" aria-current="page" style="top: 4px;" title="<?php echo e(__('center::dashboard.header.overdue_invoices')); ?>">
              ...
              <div class="card shadow-none m-0">
                <div class="card-header d-flex justify-content-between py-3" style="background: var(--bs-primary) !important;">
                  <div class="header-title">
                    <h5 class="mb-0 text-white"><?php echo e(__('center::sidebar.notifications')); ?></h5>
                  </div>
                  <?php if(auth()->user()->unreadNotifications->count() > 0): ?>
                ...
                <div class="card-body p-0" style="max-height: 350px; overflow-y: auto;">
                  <a href="<?php echo e(route('center.notifications.index')); ?>" class="iq-sub-card text-center text-primary fw-bold">
                  ...
                  <?php $__empty_1 = true; $__currentLoopData = auth()->user()->notifications->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                      ...
                      ?>
                      <a href="<?php echo e(route('center.notifications.read', $notification->id)); ?>" class="iq-sub-card <?php echo e($notification->read_at ? '' : 'bg-light'); ?>">
                        <div class="d-flex align-items-center">
                          <div class="rounded-circle bg-soft-<?php echo e($iconColor); ?> d-flex align-items-center justify-content-center p-2" style="width: 40px; height: 40px;">
                              <i class="<?php echo e($iconClass); ?> text-<?php echo e($iconColor); ?>"></i>
                          </div>
                          <div class="ms-3 w-100">
                            <h6 class="mb-0 "><?php echo e($translatedTitle); ?></h6>
                            <div class="d-flex justify-content-between align-items-center">
                              <p class="mb-0 text-truncate" style="max-width: 150px; font-size:12px;"><?php echo e($notification->data['message'] ?? ''); ?></p>
                              <small class="float-right font-size-12"><?php echo e($notification->created_at->diffForHumans()); ?></small>
                            </div>
                          </div>
                        </div>
                      </a>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" data-bs-boundary="viewport" aria-expanded="false">
              <?php if(auth()->user()->image): ?>
                  <img src="<?php echo e(asset('storage/' . auth()->user()->image)); ?>" alt="User-Profile" class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded">
              <?php else: ?>
              ...
              <?php endif; ?>
              <div class="caption ms-3 d-none d-md-block <?php echo e(app()->isLocale('ar') ? 'me-3 ms-0' : ''); ?>">
                <h6 class="mb-0 caption-title"><?php echo e(auth()->user()->name); ?></h6>
                <p class="mb-0 caption-sub-title text-capitalize"><?php echo e(auth()->user()->role ?? __('center::sidebar.admin')); ?></p>
              </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="<?php echo e(route('center.profile', ['tenant' => $tenant->domain ?? 'center'])); ?>"><?php echo e(__('center::sidebar.profile')); ?></a></li>
              <li><a class="dropdown-item" href="<?php echo e(route('center.settings.index', ['tenant' => $tenant->domain ?? 'center'])); ?>"><?php echo e(__('center::sidebar.settings')); ?></a></li>
              <li><hr class="dropdown-divider"></li>
              <li>
                <form method="POST" action="<?php echo e(route('logout')); ?>">
                  <?php echo csrf_field(); ?>
                  <a href="javascript:void(0)" class="dropdown-item" onclick="event.preventDefault(); this.closest('form').submit();">
                      <?php echo e(__('center::sidebar.logout')); ?>
...
<?php if(session()->has('impersonator_id')): ?>
    <div class="alert alert-warning mb-0 rounded-0 border-0 p-2 d-flex justify-content-between align-items-center" style="z-index: 1050; position: relative;">
        ...
        <a href="<?php echo e(route('admin.impersonate.stop')); ?>" class="btn btn-dark btn-sm rounded-pill px-3">
            <i class="fas fa-sign-out-alt me-1"></i><?php echo e(__('center::dashboard.header.logout')); ?>

        </a>
    </div>
<?php endif; ?>
<?php /**PATH D:\new project\antigravty\edu\edu\Modules\Center\resources\views\layouts\hope-header.blade.php ENDPATH**/ ?>