...
unset($__errorArgs, $__bag); ?>">
                                <option value="" <?php echo e(!old('classroom_id', $schedule->classroom_id ?? '') ? 'selected' : ''); ?>><?php echo e(__('instructor::schedules.select_hall')); ?></option>
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <?php $__currentLoopData = __('instructor::schedules.days'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value); ?>" <?php echo e(old('day_of_week', (string)($schedule->day_of_week ?? '')) === (string)$value ? 'selected' : ''); ?>>
                                        <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('start_time', isset($schedule) ? \Carbon\Carbon::parse($schedule->start_time)->format('H:i') : '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('end_time', isset($schedule) ? \Carbon\Carbon::parse($schedule->end_time)->format('H:i') : '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4 pb-2">
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold text-white shadow-sm border-0" style="background: var(--primary-color);">
                            <i class="fas fa-save me-1"></i> <?php echo e(isset($schedule) ? __('instructor::schedules.update_schedule') : __('instructor::schedules.save_schedule')); ?>
