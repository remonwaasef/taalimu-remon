<?php $__env->startSection('title', 'تفاصيل المركز - ' . $tenant->name); ?>
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.tenants.index')); ?>" class="text-decoration-none text-muted">إدارة المراكز</a></li>
                    <li class="breadcrumb-item active text-dark fw-bold" aria-current="page"><?php echo e($tenant->name); ?></li>
                </ol>
            </nav>
            <h3 class="fw-bold mb-0 text-dark">تفاصيل الحساب</h3>
        </div>
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('admin.tenants.impersonate', $tenant->id)); ?>" class="btn btn-primary rounded-pill px-4 fw-bold">
                <i class="bi bi-box-arrow-in-right me-2"></i> دخول كمسؤول
            </a>
            <a href="<?php echo e(route('admin.tenants.edit', $tenant->id)); ?>" class="btn btn-light border rounded-pill px-4 fw-bold">
                <i class="bi bi-pencil-square me-2"></i> تعديل البيانات
            </a>
            <form action="<?php echo e(route('admin.tenants.toggle-status', $tenant->id)); ?>" method="POST" class="d-inline">
                <?php echo csrf_field(); ?>
                <button type="submit" class="btn btn-outline-<?php echo e($tenant->status == 'active' ? 'danger' : 'success'); ?> rounded-pill px-4 fw-bold">
                    <i class="bi bi-power me-2"></i> <?php echo e($tenant->status == 'active' ? 'تعطيل الحساب' : 'تفعيل الحساب'); ?>
        ...
        <div class="card-body p-0">
            <div class="p-4 p-md-5 bg-gradient-emerald text-white position-relative overflow-hidden" style="background: linear-gradient(135deg, #059669 0%, #065f46 100%);">
                ...
                <div class="row align-items-center position-relative">
                    <div class="col-auto">
                        <?php if($tenant->logo): ?>
                            <img src="<?php echo e(asset('storage/' . $tenant->logo)); ?>" alt="Logo" class="rounded-4 bg-white p-2 shadow" style="width: 120px; height: 120px; object-fit: contain;">
                        <?php else: ?>
                            <div class="rounded-circle bg-white bg-opacity-20 d-flex align-items-center justify-content-center border border-white border-opacity-30 shadow-inner" style="width: 120px; height: 120px; font-size: 3rem;">
                                <?php echo e(mb_substr($tenant->name, 0, 1)); ?>
                    ...
                    <div class="col">
                        <div class="d-flex align-items-center gap-3 mb-2">
                            <h1 class="fw-bold mb-0"><?php echo e($tenant->name); ?></h1>
                            <span class="badge bg-white bg-opacity-20 rounded-pill px-3 py-1 border border-white border-opacity-30 small">
                                <i class="bi bi-<?php echo e($tenant->type === 'instructor' ? 'person-badge' : 'building'); ?> me-1"></i>
                                <?php echo e($tenant->type === 'instructor' ? 'مدرس مستقل' : 'مركز تعليمي'); ?>

                            </span>
                            <span class="badge bg-<?php echo e($tenant->status == 'active' ? 'success' : 'danger'); ?> rounded-pill px-3 py-1">
                                <?php echo e($tenant->status == 'active' ? 'نشط حالياً' : 'متوقف'); ?>

                            </span>
                        </div>
                        <div class="d-flex flex-wrap gap-4 text-white text-opacity-75">
                            <span><i class="bi bi-globe me-2"></i> <?php echo e($tenant->domain); ?>.<?php echo e(config('app.tenant_domain')); ?></span>
                            <span><i class="bi bi-calendar-check me-2"></i> انضم منذ: <?php echo e($tenant->created_at->translatedFormat('d M Y')); ?></span>
                            <span><i class="bi bi-envelope me-2"></i> <?php echo e($tenant->email ?? 'لا يوجد بريد'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 h-100 py-3">
                        <div class="card-body text-center">
                            ...
                            <h3 class="fw-bold text-dark mb-0"><?php echo e($studentsCount); ?></h3>
                            <div class="text-muted small fw-bold text-uppercase">الطلاب النشطين</div>
                            <div class="progress mt-3 mx-4" style="height: 6px;">
                                <div class="progress-bar bg-primary" style="width: <?php echo e(($limits['students']['used'] / max(1, $limits['students']['total'])) * 100); ?>%"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 h-100 py-3">
                        <div class="card-body text-center">
                            ...
                            <h3 class="fw-bold text-dark mb-0"><?php echo e($coursesCount); ?></h3>
                            <div class="text-muted small fw-bold text-uppercase">الدورات التدريبية</div>
                            <div class="progress mt-3 mx-4" style="height: 6px;">
                                <div class="progress-bar bg-purple" style="width: <?php echo e(($limits['courses']['used'] / max(1, $limits['courses']['total'])) * 100); ?>%"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 h-100 py-3 border-start border-4 border-success">
                        <div class="card-body text-center">
                            ...
                            <h3 class="fw-bold text-success mb-0"><?php echo e(number_format($totalRevenue)); ?></h3>
                            <div class="text-muted small fw-bold text-uppercase">إجمالي الإيرادات</div>
                            <div class="small text-muted mt-2">عملة المركز: <?php echo e($tenant->settings['financial']['currency'] ?? 'EGP'); ?></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card border-0 shadow-sm rounded-4 h-100 py-3 border-start border-4 border-info">
                        <div class="card-body text-center">
                            ...
                            <h3 class="fw-bold text-dark mb-0"><?php echo e(number_format($tenant->ltv)); ?></h3>
                ...
                <div class="col-lg-8">
                        ...
                        <div class="card-body px-4 pb-4">
                            <div class="row g-4">
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-0 text-dark lh-base"><?php echo e($tenant->description ?: 'لا يوجد وصف متاح.'); ?></p>
                                </div>
                                <div class="col-md-6">
                                    <label class="text-muted small fw-bold mb-1">بيانات التواصل</label>
                                    <div class="vstack gap-2">
                                        <div class="small text-dark"><i class="bi bi-telephone text-primary me-2"></i> <?php echo e($tenant->phone ?: 'غير محدد'); ?></div>
                                        <div class="small text-dark"><i class="bi bi-geo-alt text-primary me-2"></i> <?php echo e($tenant->address ?: 'غير محدد'); ?></div>
                                        <div class="small text-dark"><i class="bi bi-link-45deg text-primary me-2"></i> <?php echo e($tenant->domain); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-header bg-white py-3 px-4 d-flex justify-content-between align-items-center border-bottom-0">
                            ...
                            <a href="<?php echo e(route('admin.activity-logs.index', ['tenant_id' => $tenant->id])); ?>" class="small text-primary text-decoration-none fw-bold">عرض الكل</a>
                        </div>
                        <div class="card-body p-0">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="small fw-bold text-dark"><?php echo e($activity->description); ?></div>
                                                    <div class="x-small text-muted"><?php echo e($activity->created_at->diffForHumans()); ?></div>
                                                </td>
                                                <td class="pe-4 text-end">
                                                    <span class="badge bg-light text-muted small px-2"><?php echo e($activity->causer->name ?? 'النظام'); ?></span>
                                                </td>
                                            </tr>
                ...
                <div class="col-lg-4">
                    <div class="card border-0 shadow-sm rounded-4 mb-4">
                        ...
                        <div class="card-body px-4 pb-4 pt-0">
                            <?php $admin = $tenant->users->whereIn('role', ['center_admin', 'admin', 'instructor'])->first(); ?>
                            <?php if($admin): ?>
                                <div class="d-flex align-items-center gap-3 p-3 rounded-4 bg-light border border-light">
                                    ...
                                    <div class="overflow-hidden">
                                        <h6 class="fw-bold mb-0 text-dark text-truncate"><?php echo e($admin->name); ?></h6>
                                        <div class="text-muted small text-truncate"><?php echo e($admin->email); ?></div>
                                    </div>
                                </div>
                                <div class="mt-3">
                    ...
                    <div class="card border-0 shadow-sm rounded-4">
                        ...
                        <div class="card-body px-4 pb-4 pt-0 text-center">
                            ...
                            ?>
                            <div class="display-6 fw-bold text-<?php echo e($engColor); ?> mb-0"><?php echo e($score); ?>%</div>
                            ...
                            <div class="progress rounded-pill mb-2" style="height: 8px;">
                                <div class="progress-bar bg-<?php echo e($engColor); ?>" style="width: <?php echo e($score); ?>%"></div>
                            </div>
                            ...
                            <?php if($sub): ?>
                                    ...
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        <div>
                                            ...
                                            <h4 class="fw-bold mb-0 text-white">
                                                <?php if($sub->trial_ends_at && $sub->trial_ends_at->isFuture()): ?>
                                                    <i class="bi bi-gift me-2"></i> فترة تجريبية مجانية
                                                <?php elseif($sub->total_amount > 0): ?>
                                        ...
                                        <span class="badge bg-white bg-opacity-20 rounded-pill px-3"><?php echo e($sub->billing_cycle == 'yearly' ? 'سنوي' : ($sub->billing_cycle == 'term' ? 'ترم' : 'شهري')); ?></span>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-end mt-4">
                                        <div>
                                            <div class="x-small fw-bold text-uppercase opacity-75">اسم الباقة</div>
                                            <div class="h5 fw-bold mb-0"><?php echo e($sub->package->name ?? ($sub->type_label ?? 'مخصص')); ?></div>
                                        </div>
                                        <div class="text-end">
                                            <div class="x-small fw-bold text-uppercase opacity-75">القيمة</div>
                                            <div class="h4 fw-bold mb-0 text-white"><?php echo e(number_format($sub->total_amount)); ?> <small class="fs-6 opacity-75">ج.م</small></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="vstack gap-3 border shadow-sm rounded-4 p-3 bg-white">
                                    <div class="d-flex justify-content-between small">
                                        ...
                                        <span class="fw-bold"><?php echo e($sub->created_at->format('Y-m-d')); ?></span>
                                    </div>
                                    <div class="d-flex justify-content-between small">
                                        <span class="text-muted">تاريخ الانتهاء</span>
                                        <span class="fw-bold"><?php echo e($sub->ends_at ? $sub->ends_at->format('Y-m-d') : 'مستمر'); ?></span>
                                    </div>
                                    <?php if($sub->ends_at): ?>
                                        <?php
                                        ...
                                        <div class="text-center pt-2 mt-2 border-top">
                                            <?php if($remainingDays > 0): ?>
                                                <span class="badge bg-success bg-opacity-10 text-success rounded-pill px-3 py-2 fw-bold">متبقي <?php echo e((int)$remainingDays); ?> يوم</span>
                                            <?php else: ?>
                                                <span class="badge bg-danger bg-opacity-10 text-danger rounded-pill px-3 py-2 fw-bold">منتهي منذ <?php echo e(abs((int)$remainingDays)); ?> يوم</span>
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $subscriptionHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subHist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td class="ps-4">
                                                    <div class="fw-bold text-dark"><?php echo e($subHist->package_name ?? 'مخصص'); ?></div>
                                                    <div class="x-small text-muted"><?php echo e($subHist->billing_cycle == 'yearly' ? 'سنوي' : 'شهري'); ?></div>
                                                </td>
                                                <td><span class="fw-bold text-dark"><?php echo e(number_format($subHist->amount ?? $subHist->total_amount ?? 0)); ?> ج.م</span></td>
                                                <td class="small text-muted"><?php echo e($subHist->created_at->format('Y-m-d')); ?></td>
                                                <td class="pe-4 text-center">
                                                    <?php $logIsExpired = $subHist->ends_at && $subHist->ends_at->isPast(); ?>
                                                    <span class="badge bg-<?php echo e(!$logIsExpired ? 'success' : 'danger'); ?> bg-opacity-10 text-<?php echo e(!$logIsExpired ? 'success' : 'danger'); ?> rounded-pill px-2">
                                                        <?php echo e(!$logIsExpired ? 'نشط' : 'منتهي'); ?>
                                            ...
                                            <tr>
                                                <td class="ps-4">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div class="fw-bold text-dark"><?php echo e($member->name); ?></div>
                                                    </div>
                                                </td>
                                                <td><span class="badge bg-info bg-opacity-10 text-info rounded-pill px-3"><?php echo e($member->role == 'instructor' ? 'مدرس' : 'موظف'); ?></span></td>
                                                <td class="small"><?php echo e($member->phone ?? '-'); ?></td>
            ...
            <div class="row g-4">
                <div class="col-md-7">
                    <div class="card border-0 shadow-sm rounded-4 mb-4">
                        ...
                        <div class="card-body px-4 pb-4 pt-0">
                            <form action="<?php echo e(route('admin.tenants.notes', $tenant->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <textarea name="admin_notes" class="form-control border-0 rounded-4 mb-3 p-4 bg-light" style="min-height: 180px;" placeholder="اكتب ملاحظاتك هنا... لا تظهر للمركز"><?php echo e($tenant->admin_notes); ?></textarea>
                                <div class="text-end">
                            ...
                            <div class="row g-3">
                                <div class="col-6">
                                    <div class="p-3 bg-light rounded-4 text-center border border-light">
                                        ...
                                        <?php if($tenant->logo): ?>
                                            <img src="<?php echo e(asset('storage/' . $tenant->logo)); ?>" class="rounded shadow-sm bg-white p-2" style="max-width: 100%; height: 60px; object-fit: contain;">
                                        <?php else: ?>
                                ...
                                <div class="col-6">
                                    <div class="p-3 bg-light rounded-4 text-center border border-light">
                                        ...
                                        <?php if($tenant->favicon): ?>
                                            <img src="<?php echo e(asset('storage/' . $tenant->favicon)); ?>" class="rounded shadow-sm bg-white p-1" style="width: 40px; height: 40px; object-fit: contain;">
                                        <?php else: ?>
                        ...
                        <div class="card-body px-4 pb-4 pt-0">
                            <div class="vstack gap-2">
                                <div class="p-2 px-3 bg-light rounded-3 d-flex justify-content-between small">
                                    ...
                                    <span class="fw-bold"><?php echo e($tenant->settings['financial']['currency'] ?? 'EGP'); ?></span>
                                </div>
                                <div class="p-2 px-3 bg-light rounded-3 d-flex justify-content-between small">
                                    <span class="text-muted">نظام الدرجات</span>
                                    <span class="fw-bold text-dark"><?php echo e($tenant->settings['academic']['grading'] ?? 'N/A'); ?></span>
                                </div>
                                <div class="p-2 px-3 bg-light rounded-3 d-flex justify-content-between small">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 shadow">
            ...
            <div class="modal-body p-4">
                <form action="<?php echo e(route('admin.tenants.reset-password', $tenant->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const growthData = <?php echo json_encode($growthData, 15, 512) ?>;
