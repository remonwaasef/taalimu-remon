...
>
    ...
    <div class="hidden md:block">
        <button 
            @click="installApp()"
            class="flex items-center gap-3 py-3 px-5 bg-primary text-white font-bold rounded-<?php echo e(app()->getLocale() == 'ar' ? 'r' : 'l'); ?>-3xl shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all duration-300 group border-y border-<?php echo e(app()->getLocale() == 'ar' ? 'r' : 'l'); ?> border-white/20 backdrop-blur-sm"
        >
...
<?php if (! $__env->hasRenderedOnce('2e5d7c47-9873-4227-a71d-6b48989464a5')): $__env->markAsRenderedOnce('2e5d7c47-9873-4227-a71d-6b48989464a5'); ?>
