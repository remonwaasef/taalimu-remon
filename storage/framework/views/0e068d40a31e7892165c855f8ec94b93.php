...
<style>
    ...
    .bug-report-fab {
        position: fixed;
        bottom: 24px;
        <?php echo e(app()->getLocale() == 'ar' ? 'left' : 'right'); ?>: 24px;
        z-index: 9990;
        width: 56px;
        height: 56px;
        border-radius: 50%;
    ...
    .bug-report-fab .fab-tooltip {
        position: absolute;
        <?php echo e(app()->getLocale() == 'ar' ? 'right' : 'left'); ?>: -999px;
        bottom: 50%;
    ...
    .bug-report-fab:hover .fab-tooltip {
        <?php echo e(app()->getLocale() == 'ar' ? 'right' : 'left'); ?>: calc(100% + 12px);
        opacity: 1;
    }
...
<button type="button" class="bug-report-fab" onclick="openBugReportModal()" id="bugReportFab">
    🐛
    <span class="fab-tooltip"><?php echo e(__('center::bug_report.report_bug')); ?></span>
</button>
        ...
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-header">
                <h5 class="modal-title fw-bold">
                    <i class="fas fa-bug me-2"></i><?php echo e(__('center::bug_report.report_bug')); ?>
            ...
            <div class="modal-body" id="bugReportFormBody">
                <form id="bugReportForm" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold small"><?php echo e(__('center::bug_report.report_category')); ?></label>
                        <select name="category" class="form-select" required id="bugCategory">
                            <option value="bug">🐛 <?php echo e(__('center::bug_report.category_bug')); ?></option>
                            <option value="suggestion">💡 <?php echo e(__('center::bug_report.category_suggestion')); ?></option>
                            <option value="ui_issue">🎨 <?php echo e(__('center::bug_report.category_ui_issue')); ?></option>
                            <option value="performance">⚡ <?php echo e(__('center::bug_report.category_performance')); ?></option>
                            <option value="other">📝 <?php echo e(__('center::bug_report.category_other')); ?></option>
                        </select>
                    </div>

                    
                    <div class="mb-3">
                        <label class="form-label fw-bold small"><?php echo e(__('center::bug_report.report_title')); ?></label>
                        <input type="text" name="title" class="form-control" placeholder="<?php echo e(__('center::bug_report.report_title_placeholder')); ?>" required maxlength="255" id="bugTitle">
                    </div>

                    
                    <div class="mb-3">
                        <label class="form-label fw-bold small"><?php echo e(__('center::bug_report.report_description')); ?></label>
                        <textarea name="description" class="form-control" rows="4" placeholder="<?php echo e(__('center::bug_report.report_description_placeholder')); ?>" required maxlength="5000" id="bugDescription"></textarea>
                    </div>
                    ...
                    <div class="bug-info-badge mb-3">
                        ...
                        <?php echo e(__('center::bug_report.auto_info_notice')); ?>
                    ...
                    <button type="submit" class="btn btn-success w-100 rounded-pill py-2 fw-bold" id="bugSubmitBtn">
                        <i class="fas fa-paper-plane me-2"></i><?php echo e(__('center::bug_report.submit_report')); ?>
            ...
            <div class="modal-body d-none" id="bugReportSuccessBody">
                <div class="bug-report-success">
                    ...
                    <h4 class="fw-bold mt-3"><?php echo e(__('center::bug_report.thank_you_title')); ?></h4>
                    <p class="text-muted"><?php echo e(__('center::bug_report.thank_you_message')); ?></p>
                    <button type="button" class="btn btn-outline-success rounded-pill px-4 mt-2" onclick="closeBugReportModal()">
                        <?php echo e(__('center::bug_report.close')); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('bugReportForm').addEventListener('submit', function(e) {
        ...
        btn.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i><?php echo e(__("center::bug_report.submitting")); ?>';
        btn.disabled = true;
        ...
        fetch('<?php echo e(route("center.bug-report.store")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
        ...
        .catch(error => {
            Swal.fire({
                icon: 'error',
                title: 'Oops!',
                text: '<?php echo e(__("center::bug_report.submit_error")); ?>',
...
<?php /**PATH D:\new project\antigravty\edu\edu\Modules\Center\resources\views\partials\bug-report-widget.blade.php ENDPATH**/ ?>