<section id="pricing" class="py-24 bg-white relative overflow-hidden section-wave" 
         x-data="{ 
            ...
            getPrice(packagePrice, packageRegionalPrices) {
                ...
                return priceData || { amount: packagePrice, currency: '<?php echo e(\App\Models\SiteSetting::get('currency_code', 'USD')); ?>' };
            }
         }">
    ...
    <div class="container mx-auto px-4 lg:px-12">
        ...
        <div class="text-center mb-16" data-animate>
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#f0fdf4] border border-green-100 mb-6">
                <span class="text-xs font-black text-[#22c55e] uppercase tracking-[0.2em]"><?php echo e(__('landing.pricing.badge')); ?></span>
            </div>
            ...
            <div class="mt-12 flex justify-center">
                <div class="inline-flex items-center bg-slate-100 p-1.5 rounded-[2rem] border border-slate-200">
                    ...
                    <button 
                        ...
                        :class="billingCycle === '<?php echo e($cycle); ?>' ? 'bg-white text-[#22c55e] shadow-soft scale-105' : 'text-slate-500 hover:text-slate-800'"
                    >
                        <?php echo e(__($label)); ?>
            ...
            <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                >
                    ...
                    <div class="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#22c55e] text-white px-6 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-lg">
                        <?php echo e(__('landing.pricing.featured') ?? 'Most Popular'); ?>
                    ...
                    <div class="text-center mb-10">
                        <h3 class="text-xl font-black text-[#0f172a] mb-6 tracking-tight">
                            <?php echo e(__('landing.pricing.plans.' . $package->slug . '.name')); ?>

                        </h3>
                        
                        <!-- Price Display -->
                        <div x-data="{ localPrice: getPrice(<?php echo e($package->price); ?>, <?php echo e(json_encode($regionalPrices)); ?>) }"
                    ...
                    <ul class="space-y-4 mb-10 flex-grow">
                        ...
                        ?>
                        <?php $__currentLoopData = array_slice($pFeatures, 0, 8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-[14px] font-medium text-slate-600 leading-tight"><?php echo e($feature); ?></span>
                        </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>

                    <div class="mt-auto">
                        <a :href="'<?php echo e(route('register')); ?>?plan=<?php echo e($package->slug); ?>&cycle=' + billingCycle"
