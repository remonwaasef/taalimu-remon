    ...
    <div class="container mx-auto px-4 lg:px-8">
        ...
        <div class="text-center mb-12 lg:mb-16">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5 border border-primary/10 mb-6">
                <span class="text-sm font-medium text-primary"><?php echo e(__('landing.pricing.badge')); ?></span>
            </div>
                ...
                >
                    ...
                    <?php if($package->trial_days > 0): ?>
                        <div class="absolute -top-3 -right-3 w-12 h-12 bg-white rounded-full flex flex-col items-center justify-center shadow-lg border-4 border-primary z-20">
                            <span class="text-sm font-black text-primary leading-none"><?php echo e($package->trial_days); ?></span>
                    ...
                    <?php endif; ?>
                            ...
                            >
                                <span class="text-xs font-bold text-primary tracking-wide" x-text="localPrice.discount_label || '<?php echo e($package->discount_label ?: $package->badge); ?>'"></span>
                            </div>
                        ...
                        <div class="text-center mb-6 pt-2">
                            ...
                            <div class="flex flex-col items-center justify-center gap-1"
                                ...
                                <div class="flex items-baseline gap-1">
                                    <span class="text-4xl font-extrabold <?php echo e($isFeatured ? 'text-primary-foreground' : 'text-primary'); ?>" 
