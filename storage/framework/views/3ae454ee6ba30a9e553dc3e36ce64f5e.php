<?php $__env->startSection('title', __('center::users.add_user')); ?>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header bg-white py-3">
                <h5 class="mb-0 fw-bold"><?php echo e(__('center::users.new_user_data')); ?></h5>
            </div>
            <div class="card-body">
                <form action="<?php echo e(route('center.users.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="password" class="form-label"><?php echo e(__('center::users.password')); ?></label>
...
unset($__errorArgs, $__bag); ?>" id="role" name="role" onchange="showRoleDescription(this)">
                            <option value="" selected disabled><?php echo e(__('center::users.select_role')); ?></option>
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <option value="<?php echo e($r->name); ?>" data-desc="<?php echo e($desc); ?>" <?php echo e(old('role') == $r->name ? 'selected' : ''); ?>>
                                    <?php echo e($title); ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="card-body p-2">
                                            <?php $__currentLoopData = $perms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="form-check form-switch mb-1">
                                                    <input class="form-check-input permission-checkbox" type="checkbox" name="permissions[]" value="<?php echo e($permission->name); ?>" id="perm_<?php echo e($permission->id); ?>" <?php echo e(in_array($permission->name, old('permissions', [])) ? 'checked' : ''); ?>>
                    ...
                    <div class="d-flex gap-2 justify-content-end mt-4">
                        ...
                        <button type="submit" class="btn btn-primary"><?php echo e(__('center::users.save_user')); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('center::layouts.hope-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\new project\antigravty\edu\edu\Modules\Center\resources\views\users\create.blade.php ENDPATH**/ ?>