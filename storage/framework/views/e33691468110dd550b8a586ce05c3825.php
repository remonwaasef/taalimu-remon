<?php $__env->startSection('content'); ?>
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold text-dark"><?php echo e(__('center::courses.add_new')); ?></h2>
        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-5">
                    <form action="<?php echo e(route('center.courses.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" value="<?php echo e(old('title')); ?>" class="form-control form-control-lg bg-white border <?php $__errorArgs = ['title'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="instructor_id" class="form-select form-select-lg bg-white border <?php $__errorArgs = ['instructor_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4">
                                ...
                                <input type="number" name="price" value="<?php echo e(old('price', 0)); ?>" class="form-control form-control-lg bg-white border <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="sessions_count" value="<?php echo e(old('sessions_count', 0)); ?>" class="form-control form-control-lg bg-white border <?php $__errorArgs = ['sessions_count'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="d-flex gap-2">
                                    <input type="radio" class="btn-check" name="status" id="status_draft" value="draft" <?php echo e(old('status', 'draft') == 'draft' ? 'checked' : ''); ?>>
                                    ...
                                    <input type="radio" class="btn-check" name="status" id="status_published" value="published" <?php echo e(old('status') == 'published' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file" name="image" class="form-control form-control-lg bg-white border <?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid border-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" class="form-control form-control-lg bg-white border <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid border-danger <?php unset($message);
...
<?php echo $__env->make('center::layouts.hope-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\new project\antigravty\edu\edu\Modules\Center\resources\views\courses\create.blade.php ENDPATH**/ ?>