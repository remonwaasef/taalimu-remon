<section id="pricing" class="py-24 pb-32 bg-white relative overflow-hidden" 
    ...
    <div class="container mx-auto px-4 lg:px-12">
        ...
        <div class="text-center mb-16" data-animate>
            ...
            <div class="mt-10 flex flex-col items-center gap-6">
                ...
                <div class="inline-flex items-center bg-slate-100 p-1.5 rounded-2xl border border-slate-200">
                    <?php $__currentLoopData = ['monthly' => 'landing.pricing.monthly', 'term' => 'landing.pricing.term', 'yearly' => 'landing.pricing.yearly']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cycle => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button 
                        @click="billingCycle = '<?php echo e($cycle); ?>'"
                        class="px-6 py-2 rounded-xl text-sm font-bold transition-all duration-300 relative"
                        :class="billingCycle === '<?php echo e($cycle); ?>' ? 'bg-white text-slate-900 shadow-sm border border-slate-200/50' : 'text-slate-500 hover:text-slate-800'"
                    >
                        <?php echo e(__($label)); ?>
            ...
            <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                >
                    ...
                    <div class="absolute -top-3 left-1/2 -translate-x-1/2 bg-emerald-500 text-white px-5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider">
                        <?php echo e(__('landing.pricing.featured')); ?>
                    ...
                    <div class="mb-8">
                        <h3 class="text-lg font-bold text-slate-900 mb-2">
                            ...
                            ?>
                            <?php echo e($packageName ?: __('landing.pricing.plans.' . $package->slug . '.name')); ?>

                        </h3>
                        <p class="text-xs text-slate-400 font-medium mb-6">
                            <?php echo e($packageDesc ?: __('landing.pricing.plans.' . $package->slug . '.description')); ?>

                        </p>
                        
                        <div x-data="{ localPrice: {} }"
                             x-effect="localPrice = getRegionalPrice(<?php echo e(json_encode($package->regional_prices)); ?>, <?php echo e($package->price); ?>, <?php echo e($package->term_price); ?>, <?php echo e($package->yearly_price); ?>)"
                        >
                            <?php if($package->trial_days > 0): ?>
                                <div class="mb-3">
                                    <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-emerald-50 text-emerald-600 text-[10px] font-bold uppercase tracking-wider">
                                        ...
                                        <?php echo e(__('landing.pricing.trial_days', ['days' => $package->trial_days])); ?>
                            ...
                            <div class="mt-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest flex items-center gap-2">
                                <span x-show="billingCycle === 'monthly'"><?php echo e(__('landing.pricing.per_month')); ?></span>
                                <span x-show="billingCycle === 'term'"><?php echo e(__('landing.pricing.per_term')); ?></span>
                                <span x-show="billingCycle === 'yearly'"><?php echo e(__('landing.pricing.per_year')); ?></span>
                    ...
                    <ul class="space-y-3 mb-8 flex-grow">
                        ...
                        ?>
                        <?php $__currentLoopData = array_slice($pFeatures, 0, 7); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-slate-600 leading-tight"><?php echo e($feature); ?></span>
                        </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>

                    <div class="mt-auto">
                        <a :href="'<?php echo e(route('register')); ?>?plan=<?php echo e($package->slug); ?>&cycle=' + billingCycle + '&currency=' + selectedCurrency"
                           ...
                           <?php echo e($isFeatured 
                            ...
                            <?php echo e(__('landing.pricing.cta_paid')); ?>
        ...
        <p class="text-center text-sm font-medium text-slate-400 mt-10">
            <?php echo e(__('landing.pricing.bottom_note')); ?>
