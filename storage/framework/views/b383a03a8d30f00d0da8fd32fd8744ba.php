...
<?php $__env->startSection('page-title', __('center::attendance.management')); ?>
<?php $__env->startSection('page-subtitle', __('center::attendance.subtitle')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-header bg-white border-0 p-4 pb-0">
                    <h5 class="fw-bold mb-0"><i class="bi bi-clock-history me-2 text-primary"></i><?php echo e(__('center::attendance.today_sessions')); ?> (<?php echo e(now()->format('Y-m-d')); ?>)</h5>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle">
                            <thead class="bg-light">
                                <tr>
                                    <th class="border-0 rounded-start"><?php echo e(__('center::attendance.session_course')); ?></th>
                                    <th class="border-0"><?php echo e(__('center::attendance.instructor_classroom')); ?></th>
                                    <th class="border-0 text-center"><?php echo e(__('center::attendance.actions')); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $todaySessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="small mb-1"><i class="bi bi-person me-1"></i><?php echo e($session->instructor->name ?? __('center::attendance.unassigned_instructor')); ?></div>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="d-flex justify-content-center gap-2">
                                                <?php if($isEnded): ?>
                                                    <a href="<?php echo e(route('center.attendance.show', $session)); ?>" class="btn btn-sm btn-outline-danger rounded-pill px-3">
                                                        <i class="bi bi-person-x me-1"></i><?php echo e(__('center::attendance.view_absentees')); ?></a>
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('center.attendance.show', $session)); ?>" class="btn btn-sm btn-outline-primary rounded-pill px-3">
                                                        <i class="bi bi-card-checklist me-1"></i><?php echo e(__('center::attendance.mark_attendance')); ?></a>
                                                    <a href="<?php echo e(route('center.attendance.qr', $session)); ?>" class="btn btn-sm btn-primary rounded-pill px-3">
                                                        <i class="bi bi-qr-code me-1"></i> <?php echo e(__('center::attendance.qr_code_btn')); ?>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                                        <td colspan="3" class="text-center py-5 text-muted"><?php echo e(__('center::attendance.no_sessions_today')); ?></td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-header bg-white border-0 p-4 pb-0">
                    <h5 class="fw-bold mb-0"><i class="bi bi-ui-checks me-2 text-success"></i><?php echo e(__('center::attendance.recent_activity')); ?></h5>
                </div>
                <div class="card-body p-4">
                    <div class="list-group list-group-flush">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-auto">
                                        <span class="badge bg-<?php echo e($record->status == 'present' ? 'success' : ($record->status == 'late' ? 'warning' : 'danger')); ?> bg-opacity-10 text-<?php echo e($record->status == 'present' ? 'success' : ($record->status == 'late' ? 'warning' : 'danger')); ?> rounded-pill" style="font-size: 0.65rem;">
                                            <?php echo e($record->status == 'present' ? __('center::attendance.present') : ($record->status == 'late' ? __('center::attendance.late') : __('center::attendance.absent'))); ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <div class="text-center py-4 text-muted small"><?php echo e(__('center::attendance.no_recent_activity')); ?></div>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
