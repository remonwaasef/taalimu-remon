...
<head>
    ...
    <title><?php echo e($headerText); ?></title>
</head>
                    ...
                    <tr>
                        <td style="padding: 50px 40px 40px;">
                            <p style="color: #374151; font-size: 16px; line-height: 1.8; margin: 0 0 32px;">
                                <?php echo e($t['greeting']); ?>

                                <br>
                                <?php echo $t['student_fees']; ?> <strong style="color: #10b981;"><?php echo e($studentName); ?></strong>
                                <?php if(str_starts_with($stage, 'overdue')): ?>
                                    <?php echo $t['overdue_status']; ?>

                                <?php elseif($stage === 'due_day'): ?>
                                    <?php echo $t['due_today']; ?>

                                <?php else: ?>
                                    <?php echo str_replace(':day', $dueDay, $t['due_on_day']); ?>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 24px;">
                                <tr>
                                    <td style="background: linear-gradient(135deg, #f0fdf4 0%, #ecfdf5 100%); border: 1px solid #bbf7d0; border-radius: 12px; padding: 24px; text-align: center;">
                                        <p style="color: #6b7280; font-size: 13px; margin: 0 0 8px; font-weight: 600;"><?php echo e($t['amount_due']); ?></p>
                                        <p style="color: #059669; font-size: 32px; font-weight: 800; margin: 0;">
                                            <?php echo e($amount); ?> <span style="font-size: 16px;"><?php echo e($currency); ?></span>
                                        </p>
                                        <p style="color: #9ca3af; font-size: 12px; margin: 8px 0 0;"><?php echo e($currentMonth); ?></p>
                                    </td>
                                </tr>
                            </table>

                            <?php if(!empty($customMessage)): ?>
                                <div style="background: #fffbeb; <?php echo e($borderSide); ?>: 4px solid #f59e0b; border-radius: 8px; padding: 16px; margin-bottom: 24px;">
                                    <p style="color: #92400e; font-size: 14px; line-height: 1.8; margin: 0;">
                                        <?php echo nl2br(e($customMessage)); ?>
                            ...
                            <?php if(str_starts_with($stage, 'overdue')): ?>
                                <div style="background: #fef2f2; <?php echo e($borderSide); ?>: 4px solid #ef4444; border-radius: 8px; padding: 16px; margin-bottom: 24px;">
                                    <p style="color: #991b1b; font-size: 14px; line-height: 1.8; margin: 0;">
                                        <?php echo $t['overdue_warning']; ?>
                            ...
                            <p style="color: #6b7280; font-size: 14px; line-height: 1.8; margin: 0;">
                                ...
                                <br>
                                <strong><?php echo str_replace(':name', $tenantName, $t['management']); ?></strong>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background: #f9fafb; padding: 20px 40px; text-align: center; border-top: 1px solid #f3f4f6;">
                            <p style="color: #9ca3af; font-size: 12px; margin: 0;">
                                <?php echo e(str_replace(':name', $tenantName, $t['auto_msg'])); ?>
...
<?php /**PATH D:\new project\antigravty\edu\edu\resources\views\emails\payment-reminder.blade.php ENDPATH**/ ?>