<section class="relative pt-32 md:pt-36 lg:pt-40 pb-16 lg:pb-24 overflow-hidden bg-white" id="hero">
    ...
    <div dir="<?php echo e(app()->getLocale() == 'ar' ? 'rtl' : 'ltr'); ?>" class="container relative mx-auto px-4 lg:px-8 z-10 max-w-7xl">
        <div class="grid grid-cols-12 gap-6 lg:gap-10 items-center">
            ...
            <div class="col-span-12 md:col-span-6 text-center md:text-start order-2 md:order-1 mt-12 md:mt-0" data-animate="fade-text">
                ...
                <div class="inline-flex items-center gap-2 lg:gap-3 px-3 py-1.5 lg:px-4 lg:py-2 rounded-full bg-white border border-slate-200 shadow-sm mb-6 lg:mb-10 transition-transform hover:scale-105 cursor-pointer hover:shadow-md hover:border-emerald-200">
                    ...
                    <span class="text-[9px] lg:text-xs font-bold text-slate-700 uppercase tracking-widest leading-none"><?php echo e(__('landing.hero.badge')); ?></span>
                </div>
                ...
                <h1 class="text-3xl md:text-5xl lg:text-[4.2rem] font-black text-slate-900 leading-[1.2] lg:leading-[1.1] mb-6 lg:mb-8 tracking-tight">
                    <?php echo __('landing.hero.title', ['highlight' => '<span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-500">' . __('landing.hero.title_highlight', [], app()->getLocale()) . '</span>']); ?>
                ...
                <div class="flex flex-col sm:flex-row gap-3 lg:gap-4 items-center justify-center md:justify-start mb-10 lg:mb-16 mx-auto md:mx-0">
                    <a href="<?php echo e(route('register')); ?>" class="group relative inline-flex items-center justify-center bg-slate-900 text-white px-10 py-5 lg:px-14 lg:py-6 rounded-2xl font-black text-xl lg:text-2xl transition-all hover:bg-slate-800 shadow-xl lg:shadow-2xl ring-4 ring-slate-900/10 hover:shadow-slate-900/30 hover:-translate-y-1.5 overflow-hidden w-full sm:w-auto">
                        ...
                        <span class="relative flex items-center gap-3 lg:gap-4">
                            ...
                            <i class="fas <?php echo e(app()->getLocale() == 'ar' ? 'fa-arrow-left group-hover:-translate-x-2' : 'fa-arrow-right group-hover:translate-x-2'); ?> text-lg lg:text-2xl opacity-70 transition-transform duration-300"></i>
                        </span>
                    </a>
            ...
            <div class="col-span-12 md:col-span-6 relative w-full md:w-[95%] xl:w-[90%] md:ms-0 me-auto md:-mt-8 xl:-mt-16 order-1 md:order-2" data-animate="fade-image">
                    ...
                    <div class="bg-white/95 backdrop-blur-xl border border-emerald-100 rounded-2xl shadow-2xl overflow-hidden ring-1 ring-emerald-500/10">
                        <div class="bg-emerald-500 px-3 py-2 lg:px-4 lg:py-2.5 flex items-center justify-between">
                            <div class="flex items-center gap-1.5 lg:gap-2">
                                ...
                                <span class="text-white text-[10px] lg:text-[11px] font-bold uppercase tracking-wider"><?php echo e(__('landing.hero.mockup.whatsapp.title')); ?></span>
                            </div>
                            <span class="text-white/80 text-[9px] lg:text-[10px]"><?php echo e(__('landing.hero.mockup.whatsapp.now')); ?></span>
                        </div>
                        <div class="p-3 lg:p-5">
                            ...
                            <div class="bg-emerald-50 rounded-lg py-2 lg:py-2.5 px-4 text-center border border-emerald-100 shadow-sm transition-transform hover:scale-105 cursor-pointer">
                                <span class="text-emerald-700 font-bold text-[10px] lg:text-[13px]"><?php echo e(__('landing.hero.mockup.whatsapp.cta')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="hidden sm:flex absolute -bottom-6 -right-2 lg:-bottom-8 lg:-right-8 glass-card-premium p-3 lg:p-5 rounded-2xl shadow-xl z-30 animate-float-fast items-center gap-3 lg:gap-4 border border-white/60 bg-white/95 backdrop-blur-xl">
                    <div class="w-9 h-9 lg:w-14 lg:h-14 rounded-full bg-gradient-to-br from-emerald-100 to-emerald-50 flex items-center justify-center text-emerald-600 shadow-inner">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 lg:w-7 lg:h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <path d="M2 12h20" stroke="currentColor" class="text-emerald-400 animate-pulse" stroke-width="2"/>
                        </svg>
                    </div>
                    <div>
                        <div class="text-[9px] lg:text-[12px] font-bold text-slate-400 uppercase tracking-widest mb-0.5"><?php echo e(__('landing.hero.mockup.success.label')); ?></div>
                        <div class="text-sm lg:text-xl font-black text-slate-900 leading-none"><?php echo e(__('landing.hero.mockup.success.amount')); ?></div>
                    </div>
                </div>
                ...
                <div class="hero-3d-wrapper perspective-2000 relative z-20">
                    <div class="hero-3d-card rounded-2xl lg:rounded-[2rem] overflow-hidden border border-slate-200 shadow-2xl lg:shadow-[0_40px_120px_-20px_rgba(0,0,0,0.18)] bg-white ring-1 ring-slate-900/5 hero-3d-side">
                        ...
                        <div class="relative bg-slate-100 overflow-hidden">
                            <img src="<?php echo e(asset('images/hero-dashboard.png')); ?>" alt="Taalimu Dashboard" class="w-full h-auto object-cover object-top border-b border-white">
                        </div>
                    </div>
                </div>
...
.hero-3d-side {
    transform: <?php echo e(app()->isLocale('ar') ? 'rotateY(8deg) rotateX(2deg)' : 'rotateY(-8deg) rotateX(2deg)'); ?> scale(1);
...
@media (min-width: 1024px) {
    .hero-3d-side {
        transform: <?php echo e(app()->isLocale('ar') ? 'rotateY(12deg) rotateX(4deg)' : 'rotateY(-12deg) rotateX(4deg)'); ?> scale(0.98);
    }
}
