                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        ...
                                                        <div class="d-flex align-items-center gap-3">
                                                            ...
                                                            <div class="form-check form-switch custom-switch mb-0">
                                                                ...
                                                                <input class="form-check-input" type="checkbox" name="settings[email_templates][notif_payment_reminder_enabled]" value="1" id="notifPaymentReminder" <?php echo e(($emailSettings['notif_payment_reminder_enabled'] ?? true) ? 'checked' : ''); ?>>
                                                ...
                                                <div class="accordion-body p-4">
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        ...
                                                        <div class="form-check form-switch custom-switch mb-0">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="settings[email_templates][notif_group_enrollment_enabled]" value="1" id="notifGroupEnrollment" <?php echo e(($emailSettings['notif_group_enrollment_enabled'] ?? true) ? 'checked' : ''); ?>>
                                                    ...
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-md-4 border-end">
                                                            ...
                                                            <div class="mb-3">
                                                                <input type="text" name="settings[email_templates][notif_group_enrollment_subject_ar]" class="form-control text-end mb-2" value="<?php echo e($emailSettings['notif_group_enrollment_subject_ar'] ?? $emailSettings['notif_group_enrollment_subject'] ?? 'تم تسجيلك في مجموعة جديدة'); ?>" placeholder="الموضوع">
                                                                <textarea name="settings[email_templates][notif_group_enrollment_body_ar]" class="form-control text-end" rows="5" dir="rtl" placeholder="نص الرسالة"><?php echo e($emailSettings['notif_group_enrollment_body_ar'] ?? $emailSettings['notif_group_enrollment_body'] ?? "مرحباً {student_name}،\n\nلقد تم تسجيلك بنجاح في {group_name}.\nنتمنى لك التوفيق!\n\n{center_name}"); ?></textarea>
                                                            </div>
                                                        </div>
                                                        <!-- English -->
                                                        <div class="col-md-4 border-end">
                                                            ...
                                                            <div class="mb-3">
                                                                <input type="text" name="settings[email_templates][notif_group_enrollment_subject_en]" class="form-control text-start mb-2" value="<?php echo e($emailSettings['notif_group_enrollment_subject_en'] ?? 'You have been enrolled in a new group'); ?>" placeholder="Subject">
                                                                <textarea name="settings[email_templates][notif_group_enrollment_body_en]" class="form-control text-start" rows="5" dir="ltr" placeholder="Message body"><?php echo e($emailSettings['notif_group_enrollment_body_en'] ?? "Hello {student_name},\n\nYou have been successfully enrolled in {group_name}.\nWe wish you the best of luck!\n\n{center_name}"); ?></textarea>
                                                            </div>
                                                        </div>
                                                        <!-- French -->
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="mb-3">
                                                                <input type="text" name="settings[email_templates][notif_group_enrollment_subject_fr]" class="form-control text-start mb-2" value="<?php echo e($emailSettings['notif_group_enrollment_subject_fr'] ?? 'Vous avez été inscrit dans un nouveau groupe'); ?>" placeholder="Objet">
                                                                <textarea name="settings[email_templates][notif_group_enrollment_body_fr]" class="form-control text-start" rows="5" dir="ltr" placeholder="Corps du message"><?php echo e($emailSettings['notif_group_enrollment_body_fr'] ?? "Bonjour {student_name},\n\nVous avez été inscrit avec succès dans {group_name}.\nNous vous souhaitons bonne chance !\n\n{center_name}"); ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="accordion-body p-4">
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        ...
                                                        <div class="form-check form-switch custom-switch mb-0">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="settings[email_templates][notif_payment_confirmed_enabled]" value="1" id="notifPaymentConfirmed" <?php echo e(($emailSettings['notif_payment_confirmed_enabled'] ?? true) ? 'checked' : ''); ?>>
                                                    ...
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-md-4 border-end">
                                                            ...
                                                            <div class="mb-3">
                                                                <input type="text" name="settings[email_templates][notif_payment_confirmed_subject_ar]" class="form-control text-end mb-2" value="<?php echo e($emailSettings['notif_payment_confirmed_subject_ar'] ?? $emailSettings['notif_payment_confirmed_subject'] ?? 'تأكيد استلام دفعة'); ?>" placeholder="الموضوع">
                                                                <textarea name="settings[email_templates][notif_payment_confirmed_body_ar]" class="form-control text-end" rows="5" dir="rtl" placeholder="نص الرسالة"><?php echo e($emailSettings['notif_payment_confirmed_body_ar'] ?? $emailSettings['notif_payment_confirmed_body'] ?? "مرحباً {student_name}،\n\nنؤكد استلام دفعة مالية بقيمة {paid_amount}.\nطريقة الدفع: {payment_method}\nالمبلغ المتبقي: {remaining}\n\nشكراً لك،\n{center_name}"); ?></textarea>
                                                            </div>
                                                        </div>
                                                        <!-- English -->
                                                        <div class="col-md-4 border-end">
                                                            ...
                                                            <div class="mb-3">
                                                                <input type="text" name="settings[email_templates][notif_payment_confirmed_subject_en]" class="form-control text-start mb-2" value="<?php echo e($emailSettings['notif_payment_confirmed_subject_en'] ?? 'Payment Confirmation'); ?>" placeholder="Subject">
                                                                <textarea name="settings[email_templates][notif_payment_confirmed_body_en]" class="form-control text-start" rows="5" dir="ltr" placeholder="Message body"><?php echo e($emailSettings['notif_payment_confirmed_body_en'] ?? "Hello {student_name},\n\nWe confirm the receipt of {paid_amount}.\nPayment Method: {payment_method}\nRemaining Balance: {remaining}\n\nThank you,\n{center_name}"); ?></textarea>
                                                            </div>
                                                        </div>
                                                        <!-- French -->
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="mb-3">
                                                                <input type="text" name="settings[email_templates][notif_payment_confirmed_subject_fr]" class="form-control text-start mb-2" value="<?php echo e($emailSettings['notif_payment_confirmed_subject_fr'] ?? 'Confirmation de paiement'); ?>" placeholder="Objet">
                                                                <textarea name="settings[email_templates][notif_payment_confirmed_body_fr]" class="form-control text-start" rows="5" dir="ltr" placeholder="Corps du message"><?php echo e($emailSettings['notif_payment_confirmed_body_fr'] ?? "Bonjour {student_name},\n\nNous confirmons la réception d'un paiement de {paid_amount}.\nMéthode de paiement: {payment_method}\nSolde restant: {remaining}\n\nMerci,\n{center_name}"); ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <h2 class="accordion-header">
                                                <button class="accordion-button collapsed fw-bold bg-light" type="button" data-bs-toggle="collapse" data-bs-target="#notif_attendance">
                                                    <span class="d-flex align-items-center gap-3 w-100">
                                                        ...
                                                        <span>
                                                            <span class="d-block"><?php echo e(__('center::settings.email_templates.attendance_notif')); ?> (Multi-Lingual)</span>
                                                            <small class="text-muted fw-normal"><?php echo e(__('center::settings.email_templates.attendance_notif_desc')); ?></small>
                                                        </span>
                                                    </span>
                                                </button>
                                            </h2>
                                                ...
                                                <div class="accordion-body p-4">
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        ...
                                                        <div class="form-check form-switch custom-switch mb-0">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="settings[email_templates][notif_attendance_enabled]" value="1" id="notifAttendance" <?php echo e(($emailSettings['notif_attendance_enabled'] ?? true) ? 'checked' : ''); ?>>
                                                            <label class="form-check-label fw-bold small ms-2" for="notifAttendance"><?php echo e(__('center::settings.email_templates.notif_active')); ?></label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-md-4 border-end">
                                                            ...
                                                            <div class="mb-3">
                                                                <input type="text" name="settings[email_templates][notif_attendance_subject_ar]" class="form-control text-end mb-2" value="<?php echo e($emailSettings['notif_attendance_subject_ar'] ?? 'إشعار حضور حصة - {center_name}'); ?>" placeholder="الموضوع">
                                                                <textarea name="settings[email_templates][notif_attendance_body_ar]" class="form-control text-end" rows="5" dir="rtl" placeholder="نص الرسالة"><?php echo e($emailSettings['notif_attendance_body_ar'] ?? "مرحباً {student_name}،\n\nنود إبلاغك بأنه تم تسجيل حضورك لحصة {course_name} بنجاح.\nالحالة: {status}\n\nنتمنى لك التوفيق،\n{center_name}"); ?></textarea>
                                                            </div>
                                                        </div>
                                                        <!-- English -->
                                                        <div class="col-md-4 border-end">
                                                            ...
                                                            <div class="mb-3">
                                                                <input type="text" name="settings[email_templates][notif_attendance_subject_en]" class="form-control text-start mb-2" value="<?php echo e($emailSettings['notif_attendance_subject_en'] ?? 'Attendance Notification - {center_name}'); ?>" placeholder="Subject">
                                                                <textarea name="settings[email_templates][notif_attendance_body_en]" class="form-control text-start" rows="5" dir="ltr" placeholder="Message body"><?php echo e($emailSettings['notif_attendance_body_en'] ?? "Hello {student_name},\n\nWe would like to inform you that your attendance for {course_name} has been recorded.\nStatus: {status}\n\nBest regards,\n{center_name}"); ?></textarea>
                                                            </div>
                                                        </div>
                                                        <!-- French -->
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="mb-3">
                                                                <input type="text" name="settings[email_templates][notif_attendance_subject_fr]" class="form-control text-start mb-2" value="<?php echo e($emailSettings['notif_attendance_subject_fr'] ?? 'Notification de présence - {center_name}'); ?>" placeholder="Objet">
                                                                <textarea name="settings[email_templates][notif_attendance_body_fr]" class="form-control text-start" rows="5" dir="ltr" placeholder="Corps du message"><?php echo e($emailSettings['notif_attendance_body_fr'] ?? "Bonjour {student_name},\n\nVous avez été inscrit avec succès dans {group_name}.\nNous vous souhaitons bonne chance !\n\n{center_name}"); ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mt-3 pt-3 border-top">
                                                        <small class="fw-bold text-muted d-block mb-2"><?php echo e(__('center::settings.email_templates.placeholders_title')); ?></small>
                                                        <div class="d-flex flex-wrap gap-1">
                                                            <?php $attVars = ['student_name' => __('center::settings.email_templates.placeholders.student_name'), 'center_name' => __('center::settings.email_templates.placeholders.center_name'), 'course_name' => __('center::settings.email_templates.placeholders.course_name'), 'status' => __('center::settings.email_templates.placeholders.status'), 'date' => __('center::settings.email_templates.placeholders.date')]; ?>
                                                            <?php $__currentLoopData = $attVars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <span class="badge bg-light text-dark border py-2 px-3 rounded-pill small"><?php echo e('{'.$k.'}'); ?> : <?php echo e($l); ?></span>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </div>
                                                    </div>
...
<?php /**PATH D:\new project\antigravty\taalimu.com\taalimu.com\Modules/Center\resources/views/settings/partials/_reminders-system-notifs.blade.php ENDPATH**/ ?>