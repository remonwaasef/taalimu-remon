...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> - <?php echo e(\App\Models\SiteSetting::get('site_name', 'EduCentral')); ?></title>
...
<body style="font-family: 'Cairo', sans-serif;">
    <?php if(session()->has('impersonator_id')): ?>
        <div class="alert alert-warning mb-0 rounded-0 border-0 p-3 d-flex justify-content-between align-items-center" style="z-index: 2000; position: relative;">
            <div class="fw-bold">
                ...
                <?php echo __('admin::admin.impersonation.alert', ['name' => '<strong>' . auth()->user()->name . '</strong>']); ?>

            </div>
            <a href="<?php echo e(route('admin.impersonate.stop')); ?>" class="btn btn-dark btn-sm rounded-pill px-4 fw-bold">
                <i class="bi bi-box-arrow-right me-1"></i> <?php echo e(__('admin::admin.impersonation.stop')); ?>
    ...
    <aside class="sidebar d-flex flex-column" id="sidebar">
        <div class="p-4 mb-3 border-bottom d-flex align-items-center justify-content-between" style="border-bottom: 1px solid var(--sidebar-border) !important;">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-white text-decoration-none fs-4 fw-bold d-flex align-items-center gap-2">
                <span class="bg-primary rounded p-1 d-flex align-items-center justify-content-center text-white" style="width: 32px; height: 32px; font-size: 1.2rem;">
                    <?php echo e(substr(\App\Models\SiteSetting::get('site_name', 'EduCentral'), 0, 1)); ?>

                </span>
                <?php echo e(\App\Models\SiteSetting::get('site_name', 'EduCentral')); ?>
        ...
        <ul class="nav flex-column mb-auto">
            <li class="nav-item">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
                    <span>📊</span>
                    <span><?php echo e(__('admin::admin.sidebar.dashboard')); ?></span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('admin.tenants.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.tenants.*') || request()->routeIs('admin.subscriptions.*') ? 'active' : ''); ?>">
                    <span>🏢</span>
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.settings.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.settings.*') && !str_contains(request()->fullUrl(), 'tab=coupons') ? 'active' : ''); ?>">
                    <span>⚙️</span>
                    <span><?php echo e(__('admin::admin.sidebar.settings')); ?></span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('admin.settings.index', ['tab' => 'coupons'])); ?>" class="nav-link <?php echo e(str_contains(request()->fullUrl(), 'tab=coupons') ? 'active' : ''); ?>">
                    <span>🎟️</span>
                    <?php echo e(__('admin::admin.coupons_discounts')); ?>

                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('admin.tickets.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.tickets.*') ? 'active' : ''); ?>">
                    <span>🎫</span>
                    <span><?php echo e(__('admin::admin.sidebar.support')); ?></span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('admin.activity-logs.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.activity-logs.*') ? 'active' : ''); ?>">
                    <span>📋</span>
                    <span><?php echo e(__('admin::admin.sidebar.activity_logs')); ?></span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('admin.operation-issues.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.operation-issues.*') ? 'active' : ''); ?>">
                    <span>🔴</span>
                    <span><?php echo e(__('admin::admin.sidebar.operation_issues')); ?></span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('admin.backups.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.backups.*') ? 'active' : ''); ?>">
                    <span>💾</span>
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('admin.roles.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.roles.*') ? 'active' : ''); ?>">
                    <span>🛡️</span>
                    <span><?php echo e(__('admin::admin.sidebar.roles')); ?></span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('consent.report')); ?>" class="nav-link <?php echo e(request()->routeIs('consent.report') ? 'active' : ''); ?>">
                    <span>🍪</span>
                    <span><?php echo e(__('admin::admin.sidebar.cookie_reports')); ?></span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('admin.bug_reports.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.bug_reports.index') ? 'active' : ''); ?>">
                    <span>🐛</span>
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-main shadow-sm">
            <div class="d-flex align-items-center gap-3">
                ...
                <h4 class="mb-0 fw-bold d-none d-sm-block text-primary"><?php echo $__env->yieldContent('page-title', __('admin.title')); ?></h4>
            </div>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown user-dropdown">
                    <a href="#" class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle py-1 px-2 rounded-pill hover-bg-light" id="dropdownUserHeader" aria-expanded="false" onclick="toggleCustomDropdown(event, this)">
                        ...
                        <span class="ms-2 fw-bold d-none d-md-inline"><?php echo e(auth()->user()->name ?? __('admin::admin.sidebar.admin')); ?></span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 py-2 mt-2 rounded-4" aria-labelledby="dropdownUserHeader">
                        ...
                        <li><a class="dropdown-item py-2 px-3 rounded-3 mx-2 w-auto" href="<?php echo e(route('admin.users.edit', auth()->id())); ?>">
                            <i class="bi bi-person me-2"></i> <?php echo e(__('admin::admin.sidebar.profile')); ?>

                        </a></li>
                        <li><hr class="dropdown-divider mx-2"></li>
                        <li>
                            <form action="<?php echo e(route('admin.logout')); ?>" method="POST" id="admin-logout-form-header" class="d-none">
                                <?php echo csrf_field(); ?>
                            </form>
                            <a class="dropdown-item text-danger py-2 px-3 rounded-3 mx-2 w-auto" href="<?php echo e(route('admin.logout')); ?>" 
                               onclick="event.preventDefault(); document.getElementById('admin-logout-form-header').submit();">
                                <i class="bi bi-box-arrow-right me-2"></i> <?php echo e(__('admin.sidebar.logout')); ?>
...
<?php /**PATH D:\new project\antigravty\edu\edu\Modules\Admin\resources\views\layouts\master.blade.php ENDPATH**/ ?>