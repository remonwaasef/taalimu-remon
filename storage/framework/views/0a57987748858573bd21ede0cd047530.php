        ...
        <div class="col-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active text-primary" aria-current="page"><?php echo e(isset($asset) ? __('center::messages.blade_0105') : __('center::messages.blade_0106')); ?></li>
                </ol>
            </nav>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary px-5 rounded-pill shadow-sm fw-bold"><?php echo e(__('center::messages.blade_0103')); ?></button>
                    <a href="<?php echo e(route('center.assets.index')); ?>" class="btn btn-light px-4 rounded-pill border"><?php echo e(__('center::messages.blade_0104')); ?></a>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('center::layouts.hope-master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\new project\antigravty\edu\edu\Modules\Center\resources\views\assets\edit.blade.php ENDPATH**/ ?>