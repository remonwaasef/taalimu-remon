...
<body style="font-family: Arial, sans-serif; background-color: #f4f7fa; color: #333; margin: 0; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background: #ffffff; padding: 30px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
        <div style="text-align: center; border-bottom: 2px solid #e2e8f0; padding-bottom: 20px; margin-bottom: 20px;">
            <h2 style="color: #10b981; margin: 0;"><?php echo e($senderName); ?></h2>
        </div>
        
        <h3 style="color: #1e293b; margin-top: 0;"><?php echo e(($greetings[$locale] ?? $greetings['en'])); ?> <?php echo e($studentName); ?>،</h3>
        
        <div style="background: #f8fafc; padding: 20px; border-radius: 8px; line-height: 1.6; white-space: pre-wrap;"><?php echo e($messageContent); ?></div>
        
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e2e8f0; font-size: 14px; color: #64748b; text-align: center;">
            <p style="margin: 0;"><?php echo e($regards[$locale] ?? $regards['en']); ?></p>
            <p style="margin: 5px 0 0 0;"><strong><?php echo e($senderName); ?></strong></p>
            <p style="margin: 15px 0 0 0; font-size: 12px;"><?php echo e($autoMsg[$locale] ?? $autoMsg['en']); ?></p>
        </div>
    </div>
</body>
</html>
<?php /**PATH D:\new project\antigravty\edu\edu\resources\views\emails\custom_student_mail.blade.php ENDPATH**/ ?>