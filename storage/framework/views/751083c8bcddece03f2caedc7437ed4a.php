    ...
    <div class="container mx-auto px-4 py-5">
        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
            <div class="flex-1 text-center md:text-left">
                <h3 class="font-bold text-foreground mb-2"><?php echo e(__('gdpr.banner.title')); ?></h3>
                <p class="text-sm text-muted-foreground">
                    <?php echo e(__('gdpr.banner.message')); ?>

                    <a href="<?php echo e(route('cookies')); ?>" class="text-primary hover:underline"><?php echo e(__('gdpr.banner.learn_more')); ?></a>
                </p>
            </div>
    ...
    <div class="bg-card rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div class="p-6 border-b border-border">
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-bold text-foreground"><?php echo e(__('gdpr.settings.title')); ?></h2>
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="flex items-start gap-4">
                <div class="flex-1">
                    <div class="flex items-center gap-2 mb-2">
                        <h3 class="font-semibold text-foreground"><?php echo e(__('gdpr.settings.essential.title')); ?></h3>
                        <span class="text-xs bg-muted px-2 py-1 rounded"><?php echo e(__('gdpr.settings.always_active')); ?></span>
                    </div>
                    <p class="text-sm text-muted-foreground"><?php echo e(__('gdpr.settings.essential.description')); ?></p>
                </div>
            ...
            <div class="flex items-start gap-4">
                <div class="flex-1">
                    <h3 class="font-semibold text-foreground mb-2"><?php echo e(__('gdpr.settings.analytics.title')); ?></h3>
                    <p class="text-sm text-muted-foreground"><?php echo e(__('gdpr.settings.analytics.description')); ?></p>
                </div>
                <button 
                    id="analyticsToggle"
            ...
            <div class="flex items-start gap-4">
                <div class="flex-1">
                    <h3 class="font-semibold text-foreground mb-2"><?php echo e(__('gdpr.settings.marketing.title')); ?></h3>
                    <p class="text-sm text-muted-foreground"><?php echo e(__('gdpr.settings.marketing.description')); ?></p>
                </div>
                <button 
                    id="marketingToggle"
