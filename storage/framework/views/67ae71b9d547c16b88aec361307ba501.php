...
<?php $__env->startSection('title', 'تأكيد الدخول للمنصة'); ?>
...
<div class="card border-0 shadow-lg rounded-5 overflow-hidden animate__animated animate__fadeInUp" style="max-width: 420px; width: 100%; margin: auto; background: white;">
    <div class="card-body p-5 text-center">
        ...
        <!-- Heading -->
        <h4 class="fw-bold text-dark mb-2">مرحباً كابتن، <?php echo e($student->name); ?></h4>
        ...
        <form method="POST" action="<?php echo e(request()->fullUrl()); ?>">
            ...
            <div class="d-grid gap-3">
                ...
                <a href="<?php echo e(route('center.login')); ?>" class="btn btn-light rounded-pill py-3 fw-bold text-muted border-0">
                    العودة لصفحة الدخول
                </a>
            </div>
        </form>
