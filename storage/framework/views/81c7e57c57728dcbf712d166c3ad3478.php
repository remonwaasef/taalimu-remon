        ...
        <div class="relative animated-gradient-bg rounded-[3.5rem] p-12 lg:p-20 text-center overflow-hidden border border-white/10 shadow-premium" data-animate="scale">
            ...
            <div class="relative z-10">
                ...
                <div class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/5 border border-white/10 mb-10 backdrop-blur-xl">
                    ...
                    <span class="text-[10px] font-black text-white tracking-[0.2em] uppercase"><?php echo e(__('landing.cta.badge')); ?></span>
                </div>
                ...
                <div class="flex flex-wrap justify-center gap-12 lg:gap-24 mb-16">
                    <div class="group">
                        <div class="text-4xl lg:text-5xl font-black text-white mb-2 tracking-tighter group-hover:scale-110 transition-transform"><?php echo e(__('landing.cta.stats.revenue_value')); ?></div>
                        <div class="text-[11px] text-slate-500 font-bold uppercase tracking-[0.2em]"><?php echo e(__('landing.cta.stats.revenue')); ?></div>
                    </div>
                    <div class="group">
                        <div class="text-4xl lg:text-5xl font-black text-white mb-2 tracking-tighter group-hover:scale-110 transition-transform"><?php echo e(__('landing.cta.stats.time_value')); ?></div>
                        <div class="text-[11px] text-slate-500 font-bold uppercase tracking-[0.2em]"><?php echo e(__('landing.cta.stats.time')); ?></div>
                    </div>
                    <div class="group">
                        <div class="text-4xl lg:text-5xl font-black text-white mb-2 tracking-tighter group-hover:scale-110 transition-transform"><?php echo e(__('landing.cta.stats.trial_value')); ?></div>
                        <div class="text-[11px] text-slate-500 font-bold uppercase tracking-[0.2em]"><?php echo e(__('landing.cta.stats.trial')); ?></div>
                    </div>
                </div>

                <!-- CTA Buttons -->
                <div class="flex flex-col sm:flex-row gap-5 justify-center">
                    <a href="<?php echo e(route('register')); ?>?account_type=center" 
                       class="inline-flex items-center justify-center rounded-[1.5rem] text-sm font-black transition-all bg-[#22c55e] text-white shadow-lg shadow-green-500/20 hover:shadow-green-500/40 hover:scale-105 h-16 px-10 group whitespace-nowrap">
                        ...
                        <?php echo e(app()->isLocale('ar') ? 'ابدأ كمركز تعليمي' : 'Start as Center'); ?>

                    </a>
                    <a href="<?php echo e(route('register')); ?>?account_type=instructor" 
                       class="inline-flex items-center justify-center rounded-[1.5rem] text-sm font-black transition-all bg-white text-[#0f172a] shadow-lg hover:shadow-white/10 hover:scale-105 h-16 px-10 group whitespace-nowrap">
                        ...
                        <?php echo e(app()->isLocale('ar') ? 'ابدأ كمدرس مستقل' : 'Start as Teacher'); ?>
