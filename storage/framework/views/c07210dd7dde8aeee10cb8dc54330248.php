<?php $__env->startSection('title', __('admin::admin.title')); ?>
<?php $__env->startSection('page-title', __('admin::admin.title')); ?>
            ...
            <div class="border-bottom px-4 pt-4">
                <ul class="nav nav-tabs border-0" id="settingsTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active border-0 px-4 py-3 position-relative" id="general-tab" data-bs-toggle="tab" data-bs-target="#general" type="button" role="tab" aria-selected="true">
                            <i class="bi bi-gear me-2"></i> <?php echo e(__('admin::admin.general_settings')); ?>
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link border-0 px-4 py-3 position-relative" id="appearance-tab" data-bs-toggle="tab" data-bs-target="#appearance" type="button" role="tab" aria-selected="false">
                            <i class="bi bi-palette me-2"></i> <?php echo e(__('admin::admin.appearance')); ?>
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link border-0 px-4 py-3 position-relative" id="security-tab" data-bs-toggle="tab" data-bs-target="#security" type="button" role="tab" aria-selected="false">
                            <i class="bi bi-shield-lock me-2"></i> <?php echo e(__('admin::admin.security')); ?>
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link border-0 px-4 py-3 position-relative" id="plans-tab" data-bs-toggle="tab" data-bs-target="#plans" type="button" role="tab" aria-selected="false">
                            <i class="bi bi-card-checklist me-2"></i> <?php echo e(__('admin::admin.plans_pricing')); ?>
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link border-0 px-4 py-3 position-relative" id="features-tab" data-bs-toggle="tab" data-bs-target="#system-features" type="button" role="tab" aria-selected="false">
                            <i class="bi bi-list-check me-2"></i> <?php echo e(__('admin::admin.system_features_tab')); ?>
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link border-0 px-4 py-3 position-relative" id="coupons-tab" data-bs-toggle="tab" data-bs-target="#coupons" type="button" role="tab" aria-selected="false">
                            <i class="bi bi-ticket-perforated me-2"></i> <?php echo e(__('admin::admin.coupons_discounts')); ?>
                ...
                <div class="d-flex gap-2">
                     <button type="button" class="btn btn-outline-primary rounded-pill btn-sm px-3" data-bs-toggle="modal" data-bs-target="#addPackageModal">
                        <i class="bi bi-plus-lg me-1"></i> <?php echo e(__('admin::admin.new_package')); ?>

                    </button>
                    <button type="submit" class="btn btn-primary rounded-pill btn-sm px-4" form="mainSettingsForm">
                        <i class="bi bi-check2-circle me-1"></i> <?php echo e(__('admin::admin.save_all')); ?>
            ...
            <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST" enctype="multipart/form-data" id="mainSettingsForm">
                ...
                <div class="tab-content p-4" id="settingsTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="general" role="tabpanel">
                        <div class="row g-4">
                            <div class="col-md-6">
                                <label class="form-label fw-bold"><?php echo e(__('admin::admin.site_name')); ?></label>
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-bold"><?php echo e(__('admin::admin.admin_email')); ?></label>
                            ...
                            <div class="col-12">
                                <label class="form-label fw-bold"><?php echo e(__('admin::admin.site_description')); ?> (العربية)</label>
                                <textarea class="form-control rounded-4 shadow-sm border-light mb-3" name="site_description_ar" rows="2" dir="rtl"><?php echo e(\App\Models\SiteSetting::get('site_description_ar', \App\Models\SiteSetting::get('site_description', __('landing.hero.subtitle', [], 'ar')))); ?></textarea>
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-bold"><?php echo e(__('admin::admin.site_description')); ?> (English)</label>
                                <textarea class="form-control rounded-4 shadow-sm border-light mb-3" name="site_description_en" rows="2" dir="ltr"><?php echo e(\App\Models\SiteSetting::get('site_description_en', __('landing.hero.subtitle', [], 'en'))); ?></textarea>
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-bold"><?php echo e(__('admin::admin.site_description')); ?> (Français)</label>
                                <textarea class="form-control rounded-4 shadow-sm border-light" name="site_description_fr" rows="2" dir="ltr"><?php echo e(\App\Models\SiteSetting::get('site_description_fr', __('landing.hero.subtitle', [], 'fr'))); ?></textarea>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-bold">مدة باقة الترم (بالأيام)</label>
                                <input type="number" class="form-control rounded-4 shadow-sm border-light" name="term_duration_days" value="<?php echo e(\App\Models\SiteSetting::get('term_duration_days', 150)); ?>">
                                <small class="text-muted">الافتراضي: 150 يوم</small>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-bold"><?php echo e(__('admin::admin.currency_symbol')); ?></label>
                            ...
                            <div class="col-md-4">
                                <label class="form-label fw-bold"><?php echo e(__('admin::admin.currency_code')); ?></label>
                                                ...
                                                <div class="flex-grow-1">
                                                    <div class="row g-2">
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm bg-light fw-bold" name="packages[<?php echo e($package->id); ?>][slug]" value="<?php echo e($package->slug); ?>">
                                                        </div>
                                                        <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="text" class="form-control form-control-sm text-end" dir="ltr" name="packages[<?php echo e($package->id); ?>][name_fr]" value="<?php echo e($package->name_fr); ?>">
                                                        </div>
                                                        <div class="col-md-3">
 ...
 streams.
                                        ...
                                        <div class="bg-light p-3 rounded-4 mb-4">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <label class="form-label small fw-bold text-primary mb-0"><i class="bi bi-tag"></i> <?php echo e(__('admin::admin.base_price')); ?></label>
                                            </div>
                                            <div class="row g-2">
                                                <div class="col-3">
                                                    <label class="small text-muted mb-0"><?php echo e(__('admin::admin.price_monthly')); ?></label>
                                                    <input type="number" step="0.01" class="form-control form-control-sm" name="packages[<?php echo e($package->id); ?>][price]" value="<?php echo e($package->price); ?>">
                                                </div>
                                                <div class="col-3">
                                                    <label class="small text-muted mb-0">سعر الترم</label>
                                                    <input type="number" step="0.01" class="form-control form-control-sm" name="packages[<?php echo e($package->id); ?>][term_price]" value="<?php echo e($package->term_price); ?>">
                                                </div>
                                                <div class="col-3">
                                                    <label class="small text-muted mb-0"><?php echo e(__('admin::admin.price_yearly')); ?></label>
                                                    <input type="number" step="0.01" class="form-control form-control-sm" name="packages[<?php echo e($package->id); ?>][yearly_price]" value="<?php echo e($package->yearly_price); ?>">
                                                </div>
                                                <div class="col-3">
                                                    <label class="small text-muted mb-0"><?php echo e(__('admin::admin.old_price')); ?></label>
                                                    <input type="number" step="0.01" class="form-control form-control-sm" name="packages[<?php echo e($package->id); ?>][old_price]" value="<?php echo e($package->old_price); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bg-light p-3 rounded-4 mb-4">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <label class="form-label small fw-bold text-primary mb-0"><i class="bi bi-globe-americas"></i> <?php echo e(__('admin::admin.regional_prices')); ?> (Smart Pricing)</label>
                                                <span class="badge bg-white text-muted border"><?php echo e(__('admin::admin.auto_detected')); ?></span>
                                            </div>
                                                        ...
                                                        <div class="accordion-body p-3">
                                                            <div class="row g-2">
                                                                <div class="col-3">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-sm rounded-3 fw-bold bg-light" name="packages[<?php echo e($package->id); ?>][slug]" value="<?php echo e($package->slug); ?>">
                                                                </div>
                                                                <div class="col-3">
                                                                    <label class="small text-muted mb-0">Nom du Forfait (EN)</label>
                                                                    <input type="text" class="form-control form-control-sm rounded-3" name="packages[<?php echo e($package->id); ?>][name_en]" value="<?php echo e($package->name_en); ?>">
                                                                </div>
                                                                <div class="col-3">
                                                                    <label class="small text-muted mb-0">Nom du Forfait (FR)</label>
                                                                    <input type="text" class="form-control form-control-sm rounded-3" name="packages[<?php echo e($package->id); ?>][name_fr]" value="<?php echo e($package->name_fr); ?>">
                                                                </div>
                                                                <div class="col-3">
                                                                    <label class="small text-muted mb-0">اسم الباقة (AR)</label>
                                                                    <input type="text" class="form-control form-control-sm rounded-3" name="packages[<?php echo e($package->id); ?>][name]" value="<?php echo e($package->name); ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row g-2 mt-2">
                                                                ...
                                                                <div class="col-4">
                                                                    <label class="small text-muted mb-0">سعر الترم</label>
                                                                    <input type="number" step="0.01" class="form-control form-control-sm" name="packages[<?php echo e($package->id); ?>][regional_prices][EG][term_price]" value="<?php echo e($regional['EG']['term_price'] ?? ''); ?>">
                                                                </div>
                                                                <div class="col-4">
                                                    ...
                                                    <div id="reg_sa_<?php echo e($package->id); ?>" class="accordion-collapse collapse" data-bs-parent="#regionalAccordion<?php echo e($package->id); ?>">
                                                        <div class="accordion-body p-3">
                                                            <div class="row g-2">
                                                                ...
                                                                <div class="col-4">
                                                                    <label class="small text-muted mb-0">سعر الترم</label>
                                                                    <input type="number" step="0.01" class="form-control form-control-sm" name="packages[<?php echo e($package->id); ?>][regional_prices][SA][term_price]" value="<?php echo e($regional['SA']['term_price'] ?? ''); ?>">
                                                                </div>
                                                                <div class="col-4">
                                                                    <label class="small text-muted mb-0"><?php echo e(__('admin.price_yearly')); ?></label>
                                                    ...
                                                    <div id="reg_ae_<?php echo e($package->id); ?>" class="accordion-collapse collapse" data-bs-parent="#regionalAccordion<?php echo e($package->id); ?>">
                                                        <div class="accordion-body p-3">
                                                            <div class="row g-2">
                                                                ...
                                                                <div class="col-4">
                                                                    <label class="small text-muted mb-0">سعر الترم</label>
                                                                    <input type="number" step="0.01" class="form-control form-control-sm" name="packages[<?php echo e($package->id); ?>][regional_prices][AE][term_price]" value="<?php echo e($regional['AE']['term_price'] ?? ''); ?>">
                                                                </div>
                                                                <div class="col-4">
                                                                    <label class="small text-muted mb-0"><?php echo e(__('admin.price_yearly')); ?></label>
                                                    ...
                                                    <div id="reg_eu_<?php echo e($package->id); ?>" class="accordion-collapse collapse" data-bs-parent="#regionalAccordion<?php echo e($package->id); ?>">
                                                        <div class="accordion-body p-3">
                                                            <div class="row g-2">
                                                                ...
                                                                <div class="col-4">
                                                                    <label class="small text-muted mb-0">سعر الترم</label>
                                                                    <input type="number" step="0.01" class="form-control form-control-sm" name="packages[<?php echo e($package->id); ?>][regional_prices][FR][term_price]" value="<?php echo e($regional['FR']['term_price'] ?? ''); ?>">
                                                                </div>
                                                                <div class="col-4">
                                                                    <label class="small text-muted mb-0"><?php echo e(__('admin.price_yearly')); ?></label>
                                                    ...
                                                    <div id="reg_us_<?php echo e($package->id); ?>" class="accordion-collapse collapse" data-bs-parent="#regionalAccordion<?php echo e($package->id); ?>">
                                                        <div class="accordion-body p-3">
                                                            <div class="row g-2">
                                                                ...
                                                                <div class="col-4">
                                                                    <label class="small text-muted mb-0">سعر الترم</label>
                                                                    <input type="number" step="0.01" class="form-control form-control-sm" name="packages[<?php echo e($package->id); ?>][regional_prices][US][term_price]" value="<?php echo e($regional['US']['term_price'] ?? ''); ?>">
                                                                </div>
                                                                <div class="col-4">
                                                                    <label class="small text-muted mb-0"><?php echo e(__('admin.price_yearly')); ?></label>
                                        ...
                                        <div class="bg-light p-3 rounded-4 mb-4">
                                            <div class="mb-4 mt-3">
                                                ...
                                                <textarea class="form-control rounded-4 shadow-sm" name="packages[<?php echo e($package->id); ?>][description]" rows="3"><?php echo e($package->description); ?></textarea>

                                                <label class="form-label small fw-bold text-primary mb-2 mt-3"><i class="bi bi-card-text"></i> Description (EN)</label>
                                                <textarea class="form-control rounded-4 shadow-sm" name="packages[<?php echo e($package->id); ?>][description_en]" rows="2"><?php echo e($package->description_en); ?></textarea>

                                                <label class="form-label small fw-bold text-primary mb-2 mt-3"><i class="bi bi-card-text"></i> Description (FR)</label>
                                                <textarea class="form-control rounded-4 shadow-sm" name="packages[<?php echo e($package->id); ?>][description_fr]" rows="2"><?php echo e($package->description_fr); ?></textarea>
                                            </div>
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row g-2">
                                                        <div class="col-6">
                                                            <input type="text" class="form-control form-control-sm rounded-3" name="packages[<?php echo e($package->id); ?>][paypal_plan_id]" value="<?php echo e($package->paypal_plan_id); ?>" placeholder="PayPal Plan ID">
                                                        </div>
                                                        <div class="col-6">
                                                            <input type="text" class="form-control form-control-sm rounded-3" name="packages[<?php echo e($package->id); ?>][stripe_price_id]" value="<?php echo e($package->stripe_price_id); ?>" placeholder="Stripe Price ID">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
