...
<head>
    ...
    <title><?php echo e(__('onboarding.title')); ?></title>
...
<body class="bg-[#F8FAFC] min-h-screen text-slate-800 antialiased relative selection:bg-brand-primary selection:text-white overflow-x-hidden ltr:font-sans rtl:font-arabic">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center p-4 md:p-8 relative z-10" 
         x-data="onboardingWizard('<?php echo e($status); ?>')"
         x-init="initWizard()">
        ...
        <div class="w-full max-w-3xl">
            ...
            <div class="text-center mb-12 animate-fade-in translate-y-0 opacity-100">
                ...
                <h1 class="text-3xl md:text-5xl font-black text-slate-900 mb-4 tracking-tight leading-tight">
                    <span class="onboarding-gradient-text"><?php echo e(__('onboarding.welcome_title')); ?></span>
                </h1>
                <p class="text-slate-500 text-base md:text-lg font-medium max-w-xl mx-auto">
                    <?php echo e(__('onboarding.welcome_subtitle')); ?>
            ...
            <div class="bg-white/90 backdrop-blur-3xl rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(15,23,42,0.06)] border border-white overflow-hidden relative animate-scale-in">
                ...
                <div x-show="loading" 
                    ...
                    <p class="mt-4 text-slate-900 font-bold text-sm tracking-tight" x-text="'<?php echo e(__('onboarding.loading')); ?>'"></p>
                </div>
                ...
                <div class="p-8 md:p-14">
                    ...
                    <div x-show="currentStep === 'step_1'" 
                        ...
                        <div class="flex items-center gap-6">
                            ...
                            <div>
                                <h2 class="text-2xl font-black text-slate-900 tracking-tight"><?php echo e(__('onboarding.step_1.title')); ?></h2>
                                <p class="text-slate-500 font-medium text-sm"><?php echo e(__('onboarding.step_1.subtitle')); ?></p>
                            </div>
                        </div>
                        ...
                        <form @submit.prevent="submitStep('step_1')" class="space-y-8">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 px-1"><?php echo e(__('onboarding.step_1.currency_label')); ?></label>
                                    <select x-model="formData.step_1.currency" class="w-full bg-slate-50 border-2 border-slate-50 rounded-2xl focus:ring-emerald-500 focus:border-emerald-500 h-14 px-6 text-base font-bold transition-all hover:bg-white focus:bg-white focus:shadow-lg focus:shadow-emerald-500/5 appearance-none cursor-pointer">
                                        <option value="EGP"><?php echo e(__('onboarding.currencies.egp')); ?></option>
                                        <option value="SAR"><?php echo e(__('onboarding.currencies.sar')); ?></option>
                                        <option value="AED"><?php echo e(__('onboarding.currencies.aed')); ?></option>
                                        <option value="USD"><?php echo e(__('onboarding.currencies.usd')); ?></option>
                                        <option value="EUR"><?php echo e(__('onboarding.currencies.eur')); ?></option>
                                    </select>
                                </div>

                                <div>
                                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 px-1"><?php echo e(__('onboarding.step_1.education_system_label')); ?></label>
                                    <select x-model="formData.step_1.education_system" class="w-full bg-slate-50 border-2 border-slate-50 rounded-2xl focus:ring-emerald-500 focus:border-emerald-500 h-14 px-6 text-base font-bold transition-all hover:bg-white focus:bg-white focus:shadow-lg focus:shadow-emerald-500/5 appearance-none cursor-pointer">
                                        <?php $__currentLoopData = __('onboarding.education_systems'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="pt-6 flex justify-end">
                                <button type="submit" class="group bg-emerald-500 hover:bg-emerald-600 text-white px-10 py-5 rounded-2xl font-black text-base transition-all shadow-xl shadow-emerald-500/20 flex items-center gap-3 transform hover:-translate-y-1">
                                    <?php echo e(__('onboarding.step_1.btn_submit')); ?> 
                    ...
                    <div x-show="currentStep === 'step_2'" style="display: none;"
                        ...
                        <div class="flex items-center gap-6">
                            ...
                            <div>
                                <h2 class="text-2xl font-black text-slate-900 tracking-tight"><?php echo e(__('onboarding.step_2.title')); ?></h2>
                                <p class="text-slate-500 font-medium text-sm"><?php echo e(__('onboarding.step_2.subtitle')); ?></p>
                            </div>
                        </div>
                                    ...
                                    <div class="p-6 bg-slate-50 rounded-[2rem] border border-slate-100 relative">
                                        ...
                                        <div class="space-y-4">
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                <div>
                                                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 px-1"><?php echo e(__('onboarding.step_2.name_label')); ?></label>
                                                    <input type="text" x-model="instructor.instructor_name" placeholder="<?php echo e(__('onboarding.step_2.name_placeholder')); ?>" class="w-full bg-white border-2 border-white rounded-2xl focus:ring-emerald-500 focus:border-emerald-500 h-12 px-5 text-sm font-bold transition-all focus:shadow-lg focus:shadow-emerald-500/5" required>
                                                </div>
                                                <div>
                                                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 px-1"><?php echo e(__('onboarding.step_2.email_label')); ?></label>
                                                    <input type="email" x-model="instructor.instructor_email" placeholder="<?php echo e(__('onboarding.step_2.email_placeholder')); ?>" class="w-full bg-white border-2 border-white rounded-2xl focus:ring-emerald-500 focus:border-emerald-500 h-12 px-5 text-sm font-bold transition-all focus:shadow-lg focus:shadow-emerald-500/5">
                                                </div>
                                            </div>
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                <div>
                                                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 px-1"><?php echo e(__('onboarding.step_2.specialization_label')); ?></label>
                                                    <input type="text" x-model="instructor.instructor_specialization" placeholder="<?php echo e(__('onboarding.step_2.specialization_placeholder')); ?>" class="w-full bg-white border-2 border-white rounded-2xl focus:ring-emerald-500 focus:border-emerald-500 h-12 px-5 text-sm font-bold transition-all focus:shadow-lg focus:shadow-emerald-500/5">
                                                </div>
                                                <div>
                                                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 px-1"><?php echo e(__('onboarding.step_2.phone_label')); ?></label>
                            ...
                            <div class="pt-8 flex flex-col sm:flex-row items-center justify-between gap-6">
                                <div class="flex items-center gap-8">
                                    <button type="button" @click="prevStep()" class="text-slate-400 hover:text-slate-900 font-bold uppercase tracking-widest text-[10px] transition-all flex items-center gap-2 group">
                                        <i class="fa-solid fa-arrow-left rtl:rotate-180 group-hover:-translate-x-1 transition-transform"></i> <?php echo e(__('onboarding.btn_back')); ?>
                                    ...
                                    <button type="button" @click="submitStep('step_2', true)" class="text-slate-300 hover:text-slate-900 font-bold uppercase tracking-widest text-[10px] transition-all">
                                        <?php echo e(__('onboarding.step_2.btn_skip')); ?>
                                ...
                                <button type="submit" class="group bg-emerald-500 hover:bg-emerald-600 text-white w-full sm:w-auto px-10 py-5 rounded-2xl font-black text-base transition-all shadow-xl shadow-emerald-500/20 flex justify-center items-center gap-3 transform hover:-translate-y-1">
                                    <?php echo e(__('onboarding.step_2.btn_submit')); ?> 
                                    <i class="fa-solid fa-arrow-right rtl:rotate-180 group-hover:translate-x-1 transition-transform"></i>
                                </button>
                            </div>
                        </form>
                    ...
                    <div x-show="currentStep === 'step_3'" style="display: none;"
                        ...
                        <div class="flex items-center gap-6">
                            ...
                            <div>
                                <h2 class="text-2xl font-black text-slate-900 tracking-tight"><?php echo e(__('onboarding.step_3.title')); ?></h2>
                                <p class="text-slate-500 font-medium text-sm"><?php echo e(__('onboarding.step_3.subtitle')); ?></p>
                            </div>
                        </div>
                                    ...
                                    <div class="p-6 bg-slate-50 rounded-[2rem] border border-slate-100 relative">
                                        ...
                                        <div class="space-y-6">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                                <div>
                                                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 px-1"><?php echo e(__('onboarding.step_3.name_label')); ?></label>
                                                    <input type="text" x-model="course.course_name" placeholder="<?php echo e(__('onboarding.step_3.name_placeholder')); ?>" class="w-full bg-white border-2 border-white rounded-2xl focus:ring-emerald-500 focus:border-emerald-500 h-14 px-6 text-base font-bold transition-all focus:shadow-lg focus:shadow-emerald-500/5" required>
                                                </div>
                                                <div>
                                                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 px-1"><?php echo e(__('onboarding.step_3.price_label')); ?></label>
                                                    <div class="relative">
                                            ...
                                            <div class="p-6 bg-white rounded-2xl border border-slate-100 space-y-4">
                                                <div class="flex items-center justify-between mb-2">
                                                    <h3 class="font-black text-slate-900 text-[10px] uppercase tracking-widest flex items-center gap-2">
                                                        <i class="fa-solid fa-calendar-days text-brand-primary"></i> <?php echo e(__('onboarding.step_3.schedule_section')); ?>
                                                    ...
                                                    <button type="button" @click="course.schedules.push({day: '0', time: '16:00', time_end: '18:00'})" class="text-[10px] font-black uppercase text-brand-primary hover:underline transition-all">
                                                        + <?php echo e(__('onboarding.step_3.btn_add_schedule')); ?>
                                                    ...
                                                    <div class="grid grid-cols-1 sm:grid-cols-12 gap-4 items-end pb-4 border-b border-slate-50 last:border-0 last:pb-0">
                                                        <div class="sm:col-span-10 grid grid-cols-3 gap-3">
                                                            <select x-model="schedule.day" class="w-full bg-slate-50 border border-slate-100 rounded-xl px-3 py-2.5 text-xs font-bold">
                                                                <option value="0"><?php echo e(__('onboarding.days.0')); ?></option>
                                                                <option value="1"><?php echo e(__('onboarding.days.1')); ?></option>
                                                                <option value="2"><?php echo e(__('onboarding.days.2')); ?></option>
                                                                <option value="3"><?php echo e(__('onboarding.days.3')); ?></option>
                                                                <option value="4"><?php echo e(__('onboarding.days.4')); ?></option>
                                                                <option value="5"><?php echo e(__('onboarding.days.5')); ?></option>
                                                                <option value="6"><?php echo e(__('onboarding.days.6')); ?></option>
                                                            </select>
                            ...
                            <div class="pt-8 flex flex-col sm:flex-row items-center justify-between gap-6">
                                <div class="flex items-center gap-8">
                                    ...
                                    <button type="button" @click="submitStep('step_3', true)" class="text-slate-300 hover:text-slate-900 font-bold uppercase tracking-widest text-[10px] transition-all">
                                        <?php echo e(__('onboarding.step_3.btn_skip')); ?>

                                    </button>
                                </div>
                                <button type="submit" class="group bg-emerald-500 hover:bg-emerald-600 text-white w-full sm:w-auto px-10 py-5 rounded-2xl font-black text-base transition-all shadow-xl shadow-emerald-500/20 flex justify-center items-center gap-3 transform hover:-translate-y-1">
                                    <?php echo e(__('onboarding.step_3.btn_submit')); ?> 
                                    <i class="fa-solid fa-arrow-right rtl:rotate-180 group-hover:translate-x-1 transition-transform"></i>
                                </button>
                            </div>
                        </form>
                    ...
                    <div x-show="currentStep === 'step_4'" style="display: none;"
                        ...
                        <div class="flex items-center gap-6">
                            ...
                            <div>
                                <h2 class="text-2xl font-black text-slate-900 tracking-tight"><?php echo e(__('onboarding.step_4.title')); ?></h2>
                                <p class="text-slate-500 font-medium text-sm"><?php echo e(__('onboarding.step_4.subtitle')); ?></p>
                            </div>
                        </div>
                            ...
                            <div class="space-y-6">
                                <template x-for="(student, index) in formData.step_4.students" :key="index">
                                    <div class="p-6 bg-slate-50 rounded-[2rem] border border-slate-100 relative">
                                        ...
                                        <div class="mb-6">
                                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 px-1"><?php echo e(__('onboarding.step_4.name_label')); ?></label>
                                            <input type="text" x-model="student.student_name" placeholder="<?php echo e(__('onboarding.step_4.name_placeholder')); ?>" class="w-full bg-white border-2 border-white rounded-2xl focus:ring-emerald-500 focus:border-emerald-500 h-14 px-6 text-base font-bold transition-all focus:shadow-lg focus:shadow-emerald-500/5" required>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                                            ...
                                            <div>
                                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 px-1"><?php echo e(__('onboarding.step_4.phone_label')); ?></label>
                                        ...
                                        <div class="mb-6">
                                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 px-1"><?php echo e(__('onboarding.step_4.grade_label')); ?></label>
                                            <select x-model="student.grade_id" class="w-full bg-white border-2 border-white rounded-2xl focus:ring-emerald-500 focus:border-emerald-500 h-14 px-6 text-base font-bold transition-all focus:shadow-lg focus:shadow-emerald-500/5 appearance-none cursor-pointer">
                                                <option value=""><?php echo e(__('onboarding.step_4.grade_label')); ?>...</option>
                            ...
                            <div class="pt-8 flex flex-col sm:flex-row items-center justify-between gap-6">
                                <div class="flex items-center gap-8">
                                    ...
                                    <button type="button" @click="submitStep('step_4', true)" class="text-slate-300 hover:text-slate-900 font-bold uppercase tracking-widest text-[10px] transition-all">
                                        <?php echo e(__('onboarding.step_4.btn_skip')); ?>
                                ...
                                <button type="submit" class="group bg-emerald-500 hover:bg-emerald-600 text-white w-full sm:w-auto px-12 py-6 rounded-[2rem] font-black text-2xl transition-all shadow-[0_20px_50px_-12px_rgba(16,185,129,0.35)] flex justify-center items-center gap-4 transform hover:-translate-y-2 overflow-hidden">
                                    <span class="relative z-10 flex items-center gap-4">
                                        ...
                                        <?php echo e(__('onboarding.step_4.btn_submit')); ?>
            ...
            <div class="text-center mt-12 animate-fade-in opacity-80 hover:opacity-100 transition-opacity flex flex-col items-center gap-6">
                ...
                <p class="inline-flex items-center gap-3 px-6 py-2 rounded-full text-slate-300 text-[10px] font-black uppercase tracking-widest">
                    <i class="fa-solid fa-shield-halved text-emerald-500 text-sm"></i> <?php echo e(__('onboarding.security_note')); ?>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('onboardingWizard', (initialStatus) => ({
                ...
                steps: [
                    { id: 'step_1', label: '<?php echo e(__('onboarding.steps.step_1')); ?>' },
                    { id: 'step_2', label: '<?php echo e(__('onboarding.steps.step_2')); ?>' },
                    { id: 'step_3', label: '<?php echo e(__('onboarding.steps.step_3')); ?>' },
                    { id: 'step_4', label: '<?php echo e(__('onboarding.steps.step_4')); ?>' }
                ],
                
                formData: {
                    step_1: { 
                        locale: '<?php echo e(app()->getLocale()); ?>', 
                        currency: '<?php echo e($tenant->settings['currency'] ?? session('suggested_currency', 'EGP')); ?>',
                        education_system: '<?php echo e($tenant->settings['education_system'] ?? 'egyptian_national'); ?>'
                    },
                ...
                initWizard() {
                    const savedInstructors = <?php echo json_encode($existingInstructors ?? [], 15, 512) ?>;
                    if (savedInstructors.length > 0) {
                        this.formData.step_2.instructors = savedInstructors;
                    }

                    const savedCourses = <?php echo json_encode($existingCourses ?? [], 15, 512) ?>;
                    if (savedCourses.length > 0) {
                        this.formData.step_3.courses = savedCourses;
                    }

                    const savedStudents = <?php echo json_encode($existingStudents ?? [], 15, 512) ?>;
                ...
                async updateLanguage(locale) {
                    ...
                    this.loading = true;
                    try {
                        const response = await fetch('<?php echo e(route('center.onboarding.update-locale')); ?>', {
                            method: 'POST',
                ...
                async submitStep(stepId, skip = false) {
                    ...
                    this.loading = true;
                    try {
                        const response = await fetch('<?php echo e(route('center.onboarding.submit')); ?>', {
                            method: 'POST',
                            headers: { 'Content-Type': 'application/json', 'Accept': 'application/json' },
                            body: JSON.stringify({ _token: '<?php echo e(csrf_token()); ?>', step: stepId, skip: skip, ...this.formData[stepId] })
                        });
...
<?php /**PATH D:\new project\antigravty\edu\edu\Modules\Center\resources\views\onboarding\wizard.blade.php ENDPATH**/ ?>