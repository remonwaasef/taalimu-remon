...
<body class="rtl">
    ...
    <!-- Sidebar Component -->
    <?php echo $__env->make('admin::layouts.hope-sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <main class="main-content">
        <div class="position-relative">
            <!-- Header Component -->
            <?php echo $__env->make('admin::layouts.hope-header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        ...
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center pt-5">
                                ...
                                <div class="page-title-content animated-scaleX">
                                    <h1 class="text-white mb-2 fw-bold" style="font-size: 2.2rem; letter-spacing: -1px;"><?php echo $__env->yieldContent('page-title'); ?></h1>
                                    <p class="text-white opacity-75 mb-0 small fw-bold">
                                        <i class="bi bi-stars me-1 text-warning"></i> <?php echo $__env->yieldContent('page-subtitle'); ?>
                                    </p>
                                </div>
...
<?php /**PATH D:\new project\antigravty\edu\edu\Modules\Admin\resources\views\layouts\hope-master.blade.php ENDPATH**/ ?>