...
<?php $__env->startSection('page-title', __('center::students.title')); ?>

<?php $__env->startSection('page-actions'); ?>
    <div class="d-flex gap-2">
        <a href="<?php echo e(route('center.students.export')); ?>" class="btn btn-glass" id="export-students-btn">
            <i class="fas fa-file-export me-2"></i> <?php echo e(__('center::students.export_file')); ?>

        </a>
        <a href="<?php echo e(route('center.students.import')); ?>" class="btn btn-glass">
            <i class="fas fa-file-import me-2"></i> <?php echo e(__('center::students.import_file')); ?>

        </a>
        <a href="<?php echo e(route('center.students.create')); ?>" class="btn btn-glass">
            ...
            <div class="premium-ticket shadow-lg">
                <div class="row g-0">
                    ...
                    <div class="col-md-4 p-4 text-center d-flex flex-column align-items-center justify-content-center bg-light rounded-end-4 border-start border-dashed position-relative">
                        ...
                        <?php else: ?>
                            <div class="qr-container bg-white p-2 rounded-3 shadow-sm mb-3">
                                <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?php echo e(urlencode(url('/login'))); ?>" alt="QR Code" style="width: 140px; height: 140px;">
                            </div>
                        <?php endif; ?>
        ...
        <div class="card-body p-4">
            ...
            <div class="mb-3 d-flex flex-wrap gap-3 justify-content-between align-items-center">
                ...
                <div class="btn-group p-1 bg-light rounded-pill" role="group" style="min-width: 250px;">
                    ...
                    <label class="btn btn-sm btn-outline-primary border-0 rounded-pill px-3" for="finAll"><?php echo e(__('center::students.all')); ?></label>
                    
                    <input type="radio" class="btn-check financial-filter" name="finFilter" id="finDebt" value="debt">
                    <label class="btn btn-sm btn-outline-danger border-0 rounded-pill px-3" for="finDebt"><?php echo e(__('center::students.debtor')); ?></label>
                    
                    <input type="radio" class="btn-check financial-filter" name="finFilter" id="finPaid" value="paid">
                    <label class="btn btn-sm btn-outline-success border-0 rounded-pill px-3" for="finPaid"><?php echo e(__('center::students.paid')); ?></label>
                </div>
            </div>
                ...
                <table class="table align-middle custom-table">
                    <thead>
                        <tr>
                            ...
                            <th class="border-0 bg-transparent d-none d-lg-table-cell"><?php echo e(__('center::students.grade')); ?></th>
                    ...
                    <tbody class="border-0">
                        <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="student-row align-middle border-bottom" data-grade="<?php echo e($student->grade_id); ?>" data-fin-status="<?php echo e($student->financial_status); ?>" data-name="<?php echo e($student->name); ?>" data-phone="<?php echo e($student->phone); ?>">
                                <td class="px-3">
                                    <div class="form-check custom-check">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="student-avatar me-3">
                                            <?php if($student->profile_photo): ?>
                                                <img src="<?php echo e(Storage::url($student->profile_photo)); ?>" alt="Avatar" class="rounded-circle shadow-sm" style="width: 38px; height: 38px; object-fit: cover;">
                                            <?php else: ?>
                                                <div class="bg-primary bg-opacity-10 text-primary rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="width: 38px; height: 38px;">
                                                    <span class="fw-bold small"><?php echo e(mb_substr($student->name, 0, 1)); ?></span>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        <div>
                                            <div class="fw-bold text-dark small mb-0"><?php echo e($student->name); ?></div>
                                            <div class="text-muted extra-small d-lg-none"><?php echo e($student->phone); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="d-flex flex-column align-items-start">
                                        <span class="badge bg-<?php echo e($student->status == 'active' ? 'success' : 'danger'); ?> bg-opacity-10 text-<?php echo e($student->status == 'active' ? 'success' : 'danger'); ?> rounded-pill px-2 py-1" style="font-size: 0.7rem;">
                                            <?php echo e($student->status == 'active' ? __('center::students.active') : __('center::students.stopped')); ?>

                                        </span>
                                        <?php if($student->total_balance > 0): ?>
                                            <span class="text-danger extra-small fw-bold mt-1"><?php echo e(number_format($student->total_balance, 0)); ?> <?php echo e(get_currency_symbol()); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                <td class="text-end px-4">
                                    <div class="d-inline-flex gap-1 me-2">
                                        ...
                                        ?>
                                        <a href="https://api.whatsapp.com/send?phone=<?php echo e($phoneForWa); ?>" target="_blank" class="btn btn-sm btn-light rounded-circle text-success shadow-none p-2" title="<?php echo e(__('center::students.whatsapp')); ?>">
                                            <i class="fab fa-whatsapp"></i>
                                        </a>
                                        <button type="button" class="btn btn-sm btn-light rounded-circle text-primary shadow-none p-2 quick-pay-btn" 
                                                data-id="<?php echo e($student->id); ?>" data-name="<?php echo e($student->name); ?>" data-balance="<?php echo e($student->total_balance); ?>" title="<?php echo e(__('center::students.quick_pay')); ?>">
                                            <i class="fas fa-dollar-sign"></i>
                                        </button>
                                        <button type="button" class="btn btn-sm btn-light rounded-circle text-info shadow-none p-2 quick-enroll-btn" 
                                                data-id="<?php echo e($student->id); ?>" data-name="<?php echo e($student->name); ?>" 
                                                data-enrolled="<?php echo e($student->enrollments->pluck('course_id')->implode(',')); ?>"
                                                title="<?php echo e(__('center::students.enroll_in_course')); ?>">
                                            <i class="fas fa-plus"></i>
                                        </button>
                                        <div class="dropdown d-inline-block">
                                            <button type="button" class="btn btn-sm btn-light rounded-circle text-secondary shadow-none p-2" data-bs-toggle="dropdown" aria-expanded="false" title="<?php echo e(__('center::students.quick_report')); ?>">
                                                <i class="fas fa-share-nodes"></i>
                                            </button>
                                            <ul class="dropdown-menu dropdown-menu-end border-0 shadow rounded-3">
                                                <li>
                                                    <a class="dropdown-item rounded-3 mb-1 text-success" href="https://api.whatsapp.com/send?phone=<?php echo e($phoneForWa); ?>&text=<?php echo e(urlencode($reportMsg)); ?>" target="_blank">
                                                        <i class="fab fa-whatsapp me-2"></i> <?php echo e(__('center::students.whatsapp')); ?>
                                                ...
                                                <li>
                                                    <button type="button" class="dropdown-item rounded-3 text-primary direct-email-btn" 
                                                            ...
                                                            data-subject="<?php echo e(__('center::students.student_report_title', ['name' => $student->name])); ?>" 
                                                            data-message="<?php echo e($reportMsg); ?>">
                                                        <i class="fas fa-envelope me-2"></i> <?php echo e(__('center::students.direct_email')); ?>
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg p-2 rounded-4">
                                            ...
                                            <li><a class="dropdown-item rounded-3 mb-1" target="_blank" href="<?php echo e(route('center.students.id-card', $student->id)); ?>"><i class="fas fa-print me-2 text-secondary opacity-75"></i> <?php echo e(__('center::students.print_id_card')); ?></a></li>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="7" class="text-center py-5">
                                    ...
                                    <h5 class="text-muted fw-bold"><?php echo e(__('center::students.no_students')); ?></h5>
                                    <p class="text-muted small"><?php echo e(__('center::students.add_import_hint')); ?></p>
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
            ...
            <div class="modal-content border-0 rounded-4 shadow">
                <form action="<?php echo e(route('center.sales.mark-paid')); ?>" method="POST">
                    ...
                    <div class="modal-body p-4 text-center">
                        ...
                        <p class="text-muted small mb-4"><?php echo e(__('center::students.quick_pay_desc')); ?></p>
                        
                        <div class="mb-3 text-start">
                            <label class="form-label fw-bold small text-muted"><?php echo e(__('center::students.collected_amount')); ?></label>
                            <div class="input-group">
                                <input type="number" name="amount" id="payAmountInput" class="form-control rounded-start-pill" required>
                                <span class="input-group-text rounded-end-pill"><?php echo e(get_currency_symbol()); ?></span>
                            </div>
                            <div id="payBalanceHint" class="x-small text-danger mt-1"></div>
                        </div>

                        <button type="submit" class="btn btn-success w-100 rounded-pill py-2 fw-bold"><?php echo e(__('center::students.confirm_payment')); ?></button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content border-0 rounded-4 shadow">
                <form id="enrollForm" method="POST">
                    ...
                    <div class="modal-header border-0 pb-0">
                        <h5 class="fw-bold"><i class="fas fa-plus-circle me-2 text-info"></i><?php echo e(__('center::students.enroll_in_course')); ?></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body p-4">
                        <p class="small text-muted mb-4"><?php echo e(__('center::students.quick_enroll_desc', ['name' => '<span class="fw-bold text-dark" id="enrollStudentName"></span>'])); ?></p>
                        <div class="mb-3">
                            <label class="form-label fw-bold small"><?php echo e(__('center::students.available_courses')); ?></label>
                            <select id="courseSelect" class="form-select rounded-pill" required>
                                <option value=""><?php echo e(__('center::students.choose_course')); ?></option>
                                <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($course->id); ?>"><?php echo e($course->title); ?> (<?php echo e(number_format($course->price, 0)); ?> <?php echo e(get_currency_symbol()); ?>)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="alert alert-soft-info x-small border-0 rounded-3">
                            <?php echo e(__('center::students.auto_invoice_hint')); ?>

                        </div>
                        <div id="enrollWarning" class="alert alert-soft-danger x-small border-0 rounded-3 mt-2 d-none">
                            <i class="fas fa-exclamation-circle me-2"></i> <?php echo e(__('center::students.already_enrolled_warning')); ?>

                        </div>
                    </div>
                    <div class="modal-footer border-0 pt-0">
                        <button type="button" id="submitEnrollBtn" class="btn btn-info text-white w-100 rounded-pill py-2 fw-bold"><?php echo e(__('center::students.complete_enrollment')); ?></button>
                    </div>
                </form>
            </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.quick-pay-btn').forEach(btn => {
                btn.addEventListener('click', function() {
                    if (payModal) {
                        ...
                        document.getElementById('payBalanceHint').textContent = '<?php echo e(__('center::students.current_balance')); ?>: ' + this.dataset.balance + ' <?php echo e(get_currency_symbol()); ?>';
                        payModal.show();
                    }
                });
            });
                    ...
                    if (enrollModal) {
                        ...
                        options.forEach(opt => {
                            if (opt.value && enrolledIds.includes(opt.value)) {
                                ...
                                if (!opt.textContent.includes('<?php echo e(__('center::students.already_enrolled_label')); ?>')) {
                                    opt.textContent = opt.textContent + ' <?php echo e(__('center::students.already_enrolled_label')); ?>';
                                }
                            } else {
                                opt.removeAttribute('data-enrolled');
                                opt.textContent = opt.textContent.replace(' <?php echo e(__('center::students.already_enrolled_label')); ?>', '');
                            }
                        });
            ...
            document.getElementById('submitEnrollBtn').addEventListener('click', function() {
                ...
                if (!courseId) return alert('<?php echo e(__('center::students.choose_course_first')); ?>');
            ...
            document.querySelectorAll('.direct-email-btn').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    if (confirm('<?php echo e(__('center::students.send_report_confirm')); ?>')) {
                        form.submit();
                    }
                });
            });
        ...
        $(document).ready(function() {
            if ($.fn.select2) {
                $('#courseSelect').select2({
                    ...
                    width: '100%',
                    language: {
                        noResults: function() { return "<?php echo e(__('center::students.no_results')); ?>"; }
                    }
                });
            }
        });
