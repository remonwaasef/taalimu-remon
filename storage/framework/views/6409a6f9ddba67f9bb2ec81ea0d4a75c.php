<?php $__env->startSection('page-title', __('instructor::online_classes.edit_lesson')); ?>
            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-header bg-white border-0 pt-4 pb-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="fw-bold mb-0" style="color: var(--primary-color);"><?php echo e(__('instructor::online_classes.update_lesson')); ?></h4>
                            <p class="text-muted small mb-0"><?php echo e(__('instructor::online_classes.add_online_class_desc')); ?></p>
                        </div>
                    </div>
                </div>
                <div class="card-body p-4">
                    <form action="<?php echo e(route('instructor.online_classes.update', $onlineClass->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('title', $onlineClass->title)); ?>" required placeholder="<?php echo e(__('instructor::online_classes.lesson_title_placeholder')); ?>">
...
unset($__errorArgs, $__bag); ?>" required>
                                    <option value="" disabled><?php echo e(__('instructor::online_classes.select_group')); ?></option>
                                    <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($course->id); ?>" <?php echo e(old('course_id', $onlineClass->course_id) == $course->id ? 'selected' : ''); ?>><?php echo e($course->title); ?></option>
...
unset($__errorArgs, $__bag); ?>" required>
                                    <option value="zoom" <?php echo e(old('platform', $onlineClass->platform) == 'zoom' ? 'selected' : ''); ?>>Zoom</option>
                                    <option value="google_meet" <?php echo e(old('platform', $onlineClass->platform) == 'google_meet' ? 'selected' : ''); ?>>Google Meet</option>
                                    <option value="microsoft_teams" <?php echo e(old('platform', $onlineClass->platform) == 'microsoft_teams' ? 'selected' : ''); ?>>Microsoft Teams</option>
                                    <option value="other" <?php echo e(old('platform', $onlineClass->platform) == 'other' ? 'selected' : ''); ?>><?php echo e(__('instructor::online_classes.other')); ?></option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('meeting_link', $onlineClass->meeting_link)); ?>" required placeholder="<?php echo e(__('instructor::online_classes.enter_link_placeholder')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('meeting_id', $onlineClass->meeting_id)); ?>" placeholder="123 456 789">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('meeting_password', $onlineClass->meeting_password)); ?>" placeholder="123456">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('start_time', $onlineClass->start_time->format('Y-m-d\TH:i'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('duration_minutes', $onlineClass->duration_minutes)); ?>" min="1" required>
...
unset($__errorArgs, $__bag); ?>" required>
                                    <option value="scheduled" <?php echo e(old('status', $onlineClass->status) == 'scheduled' ? 'selected' : ''); ?>><?php echo e(__('instructor::online_classes.scheduled')); ?></option>
                                    <option value="in_progress" <?php echo e(old('status', $onlineClass->status) == 'in_progress' ? 'selected' : ''); ?>><?php echo e(__('instructor::online_classes.in_progress')); ?></option>
                                    <option value="completed" <?php echo e(old('status', $onlineClass->status) == 'completed' ? 'selected' : ''); ?>><?php echo e(__('instructor::online_classes.completed')); ?></option>
                                    <option value="canceled" <?php echo e(old('status', $onlineClass->status) == 'canceled' ? 'selected' : ''); ?>><?php echo e(__('instructor::online_classes.canceled')); ?></option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary rounded-pill px-4 fw-bold" style="background: var(--primary-color);"><?php echo e(__('instructor::online_classes.update_lesson')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
