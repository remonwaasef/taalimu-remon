...
<div class="min-h-screen bg-slate-50/50 flex justify-center items-center p-4 lg:p-8" 
    ...
    <div class="w-full max-w-md bg-white rounded-[40px] shadow-2xl shadow-slate-200/60 p-8 lg:p-10 border border-slate-100 animate-fade-in-up">
        ...
        <div class="text-center mb-8">
            <div class="d-inline-flex justify-center items-center rounded-full bg-slate-900 text-white w-20 h-20 mb-4 mx-auto text-2xl font-bold shadow-sm">
                Edu
            </div>
            <h1 class="text-2xl font-bold text-slate-900 mb-2 font-arabic tracking-tight">
                <?php echo e(__('تسجيل دخول المشرف')); ?>

            </h1>
            <p class="text-slate-500 text-sm font-arabic font-light">
                <?php echo e(__('لوحة التحكم الرئيسية')); ?>
        ...
        <form action="<?php echo e(route('admin.login.submit')); ?>" method="POST" class="space-y-5" x-data="{ showPassword: false }">
            <?php echo csrf_field(); ?>
            
            <div class="space-y-1.5">
                <label class="text-[11px] font-bold text-slate-500 px-1 font-arabic uppercase tracking-wider"><?php echo e(__('البريد الإلكتروني')); ?></label>
            ...
            <div class="space-y-1.5">
                <div class="flex justify-between items-center px-1">
                    <label class="text-[11px] font-bold text-slate-500 font-arabic uppercase tracking-wider"><?php echo e(__('كلمة المرور')); ?></label>
            ...
            <div class="pt-4">
                <button type="submit" 
                    class="w-full h-14 btn-submit-compact text-white font-bold text-base flex justify-center items-center gap-2 group bg-slate-900 hover:bg-slate-800 shadow-slate-900/20">
                    <span class="font-arabic"><?php echo e(__('دخول')); ?></span>
                    <svg class="w-4 h-4 text-white/80 group-hover:-translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
