    ...
    <div class="row g-4">
        <div class="col-md-4">
            <div class="card border-0 shadow-sm rounded-ultra p-4 text-center">
                ...
                <p class="text-muted small mb-4"><?php echo e($student->grade_level_name); ?></p>
                ...
                <div class="card-body p-4 pt-0">
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <div class="p-3 bg-light rounded-3 fw-bold"><?php echo e($student->name); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label text-muted small">البريد الإلكتروني</label>
                            <div class="p-3 bg-light rounded-3 fw-bold"><?php echo e($student->email); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label text-muted small">رقم الهاتف</label>
                            <div class="p-3 bg-light rounded-3 fw-bold text-ltr"><?php echo e($student->phone); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label text-muted small">رقم هاتف ولي الأمر</label>
                            <div class="p-3 bg-light rounded-3 fw-bold text-ltr"><?php echo e($student->parent_phone); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label text-muted small">المرحلة الدراسية</label>
                            <div class="p-3 bg-light rounded-3 fw-bold"><?php echo e($student->grade_level_name); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label text-muted small">كود الطالب</label>
                            <div class="p-3 bg-light rounded-3 fw-bold">STD-<?php echo e(str_pad($student->id, 5, '0', STR_PAD_LEFT)); ?></div>
                        </div>
                    </div>
                </div>
            </div>
