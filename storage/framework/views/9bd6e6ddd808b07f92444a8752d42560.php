    ...
    <div class="max-w-md w-full space-y-8 animate-fade-in-up">
        <div class="bg-white border border-slate-100/50 rounded-[2.5rem] shadow-2xl shadow-blue-900/5 p-8 lg:p-10 backdrop-blur-xl relative overflow-hidden">
            ...
            <div class="text-center mb-8">
                <h2 class="text-3xl font-bold gradient-hero bg-clip-text text-transparent mb-2"><?php echo e(__('auth.login.title')); ?></h2>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               ...
                               class="block w-full ps-10 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-slate-900 focus:ring-4 focus:ring-brand-secondary/10 focus:border-brand-secondary transition-all <?php $__errorArgs = ['email'];
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" 
                               id="password" 
                               name="password" 
                               class="block w-full ps-10 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-slate-900 focus:ring-4 focus:ring-brand-secondary/10 focus:border-brand-secondary transition-all <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <a href="<?php echo e(route('auth.google')); ?>" class="w-full flex items-center justify-center gap-2 py-3 px-4 border border-gray-300 rounded-xl shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-secondary/20 transition-all">
