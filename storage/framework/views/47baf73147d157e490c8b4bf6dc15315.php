    ...
    <div class="container-fluid py-5 px-4 px-md-5 position-relative z-target text-end">
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <h1 class="display-6 fw-bold text-white mb-2">أهلاً بك، <?php echo e(explode(' ', auth()->user()->name)[0]); ?>! 👋</h1>
                ...
                <?php if($nextLesson): ?>
                    <div class="d-inline-flex align-items-center gap-3 p-2 bg-white bg-opacity-10 backdrop-blur rounded-pill border border-white border-opacity-10 animate__animated animate__pulse animate__infinite">
                        ...
                        <div class="me-3">
                            ...
                            <a href="<?php echo e(route('center.courses.player', ['course' => $lastEnrollment->course_id, 'lesson' => $nextLesson->id])); ?>" class="text-white fw-bold text-decoration-none small stretched-link"><?php echo e($nextLesson->title); ?></a>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
    ...
    <div class="stats-floating-bar mx-auto bg-white rounded-pill p-2 shadow-sm d-flex align-items-center justify-content-around px-3 mx-lg-5 border" style="max-width: 800px;">
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                ...
                <div class="fw-bold small"><?php echo e($points ?? 0); ?></div>
            </div>
        </div>
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                ...
                <div class="fw-bold small">#<?php echo e($rank ?? '-'); ?></div>
            </div>
        </div>
        <div class="vr opacity-10"></div>
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                ...
                <div class="fw-bold small"><?php echo e($enrollments->count()); ?></div>
            </div>
        </div>
    </div>
</div>
...
<div class="mt-5 pt-3">
    ...
    <div class="row g-4 mb-5 animate__animated animate__fadeInUp">
        <div class="col-6 col-md-3">
            <a href="<?php echo e(route('campus.courses.index')); ?>" class="service-card text-decoration-none color-inherit">
        ...
        <div class="col-6 col-md-3">
            <a href="<?php echo e(route('campus.schedule')); ?>" class="service-card text-decoration-none color-inherit">
                <div class="card border-0 shadow-sm rounded-4 p-4 text-center h-100 transition-all">
        ...
        <div class="col-6 col-md-3">
            <a href="<?php echo e(route('campus.attendance')); ?>" class="service-card text-decoration-none color-inherit">
                <div class="card border-0 shadow-sm rounded-4 p-4 text-center h-100 transition-all">
        ...
        <div class="col-6 col-md-3">
            <a href="<?php echo e(route('campus.finances')); ?>" class="service-card text-decoration-none color-inherit">
                <div class="card border-0 shadow-sm rounded-4 p-4 text-center h-100 transition-all">
...
<div class="mt-5">
    <div class="d-flex align-items-center justify-content-between mb-4 px-2">
        ...
        <a href="<?php echo e(route('campus.courses.index')); ?>" class="text-primary text-decoration-none extra-small fw-bold">استكشف المزيد <i class="fas fa-arrow-left ms-1 small"></i></a>
    </div>
    ...
    <div class="row g-4 animate__animated animate__fadeInUp">
        <?php $__empty_1 = true; $__currentLoopData = $enrollments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enrollment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="col-md-6 col-lg-4">
                <a href="<?php echo e(route('center.courses.player', ['course' => $course->id])); ?>" class="text-decoration-none">
                    <div class="card border-0 shadow-soft rounded-5 h-100 premium-course-card overflow-hidden">
                        <div class="position-relative overflow-hidden" style="height: 160px;">
                            <?php if($course->image): ?>
                                <img src="<?php echo e(asset('storage/' . $course->image)); ?>" class="w-100 h-100 object-fit-cover card-img-scale">
                            <?php else: ?>
                            ...
                            <div class="position-absolute top-0 end-0 m-3">
                                <span class="badge glass-badge rounded-pill px-3 py-2 text-white fw-bold shadow-sm">
                                    <?php echo e($enrollment->status_label ?? 'نشط'); ?>
                        ...
                        <div class="card-body p-4">
                            <h6 class="fw-bold text-dark mb-3 line-clamp-1" title="<?php echo e($course->title); ?>"><?php echo e($course->title); ?></h6>
                            
                            <!-- Premium Progress Bar -->
                            <div class="mb-2">
                                <div class="d-flex justify-content-between extra-small mb-2">
                                    <span class="text-muted fw-bold">مستوى الإنجاز</span>
                                    <span class="text-primary fw-bold"><?php echo e($enrollment->progress_percent ?? 0); ?>%</span>
                                </div>
                                <div class="progress-premium-container">
                                    <div class="progress-premium-bar" style="width: <?php echo e($enrollment->progress_percent ?? 0); ?>%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="col-12 text-center py-5">
                <div class="empty-state-card p-5 rounded-5 bg-white shadow-sm border border-dashed text-center">
                    ...
                    <a href="<?php echo e(route('campus.courses.index')); ?>" class="btn btn-primary rounded-pill px-5 py-2 mt-4 fw-bold shadow-sm">تصفح الدورات</a>
                </div>
            </div>
        <?php endif; ?>
    </div>
