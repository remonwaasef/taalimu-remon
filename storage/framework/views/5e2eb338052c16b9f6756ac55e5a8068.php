        ...
        <div class="card-body d-flex flex-column" style="height: 400px;">
            <div id="chatbot-messages" class="flex-grow-1 overflow-auto mb-3" style="max-height: 350px;">
                <div class="text-center text-muted py-4">
                    <p><?php echo e(__('center::messages.blade_0265')); ?></p>
                </div>
            </div>
            <div class="input-group">
                <input type="text" id="chatbot-input" class="form-control" placeholder="<?php echo e(__('center::messages.blade_0267')); ?>">
                <button id="chatbot-send" class="btn btn-primary"><?php echo e(__('center::messages.blade_0266')); ?></button>
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const sendMessage = async () => {
        ...
        try {
            const response = await fetch('<?php echo e(route("ai.chatbot", ["tenant" => $tenant->domain])); ?>', {
                method: 'POST',
                headers: {
...
<?php /**PATH D:\new project\antigravty\edu\edu\Modules\Center\resources\views\components\chatbot-widget.blade.php ENDPATH**/ ?>