...
<body style="font-family: 'Segoe UI', Arial, sans-serif; background-color: #eff6ff; color: #333; margin: 0; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 16px; box-shadow: 0 4px 24px rgba(59, 130, 246, 0.1); overflow: hidden;">
        ...
        <div style="padding: 30px;">
            <h3 style="color: #1e293b; margin-top: 0; font-size: 18px;">{{ ($greetings[$locale] ?? $greetings['en']) }} {{ $guardianName }}،</h3>
            
            <div style="background: #f8fafc; padding: 20px; border-radius: 12px; line-height: 1.8; white-space: pre-wrap; font-size: 15px; {{ $borderSide }}: 4px solid #3b82f6;">{{ $messageContent }}</div>
        </div>
