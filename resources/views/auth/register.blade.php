                ...
                <div class="max-w-[440px] mx-auto pt-10">
                    ...
                    <div class="mb-8 relative" x-cloak>
                        <div class="flex justify-between mb-2">
                            <span class="text-[10px] font-bold uppercase tracking-widest transition-colors" :class="currentStep === 1 ? 'text-brand-secondary' : 'text-slate-400'">{{ app()->getLocale() == 'ar' ? 'بيانات المركز' : 'Center Info' }}</span>
                            <span class="text-[10px] font-bold uppercase tracking-widest transition-colors" :class="currentStep === 2 ? 'text-brand-secondary' : 'text-slate-400'">{{ app()->getLocale() == 'ar' ? 'البيانات الشخصية' : 'Personal Details' }}</span>
                        </div>
                    ...
                    <div class="mb-8" x-show="currentStep === 1">
                        <h1 class="text-2xl lg:text-4xl font-black text-slate-900 mb-3 font-arabic leading-tight">
                            {{ app()->getLocale() == 'ar' ? 'أهلاً بك! لنبدأ تجهيز مركزك' : 'Welcome! Let\'s setup your center' }}
                        </h1>
                        <p class="text-slate-500 text-sm lg:text-base font-arabic font-medium opacity-80">
                            {{ app()->getLocale() == 'ar' ? 'اختر اسماً ورابطاً مميزاً للمنصة الخاصة بك' : 'Choose a unique name and link for your platform' }}
                        </p>
                    </div>

                    <div class="mb-8" x-show="currentStep === 2" x-cloak style="display: none;">
                        <h1 class="text-2xl lg:text-4xl font-black text-slate-900 mb-3 font-arabic leading-tight">
                            {{ app()->getLocale() == 'ar' ? 'خطوة أخيرة لتأكيد حسابك' : 'Final step to confirm your account' }}
                        </h1>
                        <p class="text-slate-500 text-sm lg:text-base font-arabic font-medium opacity-80">
                            {{ app()->getLocale() == 'ar' ? 'أدخل بياناتك الشخصية للبدء فوراً' : 'Enter your personal details to get started immediately' }}
                        </p>
                    </div>
