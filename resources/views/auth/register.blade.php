                ...
                <div x-show="currentStep === 1" x-cloak>
                    ...
                    <div class="mb-3">
                        <a :href="'{{ route('auth.google') }}?plan=' + selectedPlan + '&cycle=' + billingCycle + '&account_type=' + (accountType || 'center')" 
                           class="w-full flex items-center justify-center gap-2.5 py-2.5 px-4 border border-slate-200 rounded-xl text-xs font-black text-slate-700 bg-white hover:bg-slate-50 hover:border-slate-300 hover:shadow-xs transition-all group">
                            ...
                            <span class="font-arabic">{{ __('auth.register.google_signup') }}</span>
                        </a>
                    </div>

                    <!-- Divider -->
                    <div class="relative my-3.5 px-6">
                        <div class="absolute inset-0 flex items-center"><div class="w-full border-t border-slate-100"></div></div>
                        <div class="relative flex justify-center text-[11px]">
                            <span class="bg-white px-3 text-slate-400 font-bold font-arabic">
                                {{ __('auth.registration_steps.or_email') }}
                            </span>
                        </div>
                    </div>
