...
@section('content')
<div class="min-h-screen flex items-center justify-center py-10 lg:py-16 px-4 sm:px-6 lg:px-8 bg-slate-50/50 mesh-gradient-soft noise-overlay">
    <div class="max-w-md w-full space-y-6 animate-fade-in-up">
        <div class="bg-white border border-slate-100/50 rounded-[1.5rem] shadow-2xl shadow-blue-900/5 p-6 lg:p-8 backdrop-blur-xl relative overflow-hidden">
            ...
            <div class="text-center mb-6">
                <h2 class="text-2xl font-bold gradient-hero bg-clip-text text-transparent mb-1.5">{{ __('auth.login.title') }}</h2>
                <p class="text-muted-foreground text-sm">{{ __('auth.login.subtitle') }}</p>
            </div>
