                ...
                <div x-show="currentStep === 1" x-cloak x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        <label class="text-[13px] font-black text-slate-400 px-1 font-arabic uppercase tracking-wide">{{ __('auth.registration_steps.platform_link') }}</label>
                    ...
                    <div class="pt-2">
                        <button type="button" @click="nextStep()"
                            ...
                            <span class="text-base font-black font-arabic">{{ __('auth.registration_steps.continue') }}</span>
