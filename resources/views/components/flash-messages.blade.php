<div class="flash-messages-container">
    ...
    @if(session('info'))
        <div class="alert alert-info alert-dismissible fade show shadow-sm rounded-3 border-0 mb-4" role="alert">
            <div class="d-flex align-items-center">
                ...
                <div class="fw-medium text-info">{{ session('info') }}</div>
            </div>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
    @endif
    ...
    @if(session('warning'))
        <div class="alert alert-warning alert-dismissible fade show shadow-sm rounded-3 border-0 mb-4" role="alert">
            <div class="d-flex align-items-center">
    ...
    @if ($errors->any())
        <div class="alert alert-danger alert-dismissible fade show shadow-sm rounded-3 border-0 mb-4" role="alert">
            <div class="d-flex">
                ...
                <div>
                    <h6 class="alert-heading fw-bold text-danger mb-1">{{ __('center::messages.validation_error') ?? 'يرجى مراجعة الأخطاء التالية:' }}</h6>
