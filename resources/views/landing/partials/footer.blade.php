    ...
    <div class="container relative mx-auto px-4 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 md:gap-12 mb-20">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li><a href="#features" class="text-white/70 hover:text-cyan transition-colors duration-300 text-sm font-medium">{{ __('landing.footer.product.features') }}</a></li>
                    <li><a href="#pricing" class="text-white/70 hover:text-cyan transition-colors duration-300 text-sm font-medium">{{ __('landing.footer.product.pricing') }}</a></li>
                    <li><a href="#" class="text-white/70 hover:text-cyan transition-colors duration-300 text-sm font-medium">{{ __('landing.footer.product.integrations') }}</a></li>
                    <li><a href="#" class="text-white/70 hover:text-cyan transition-colors duration-300 text-sm font-medium">{{ __('landing.footer.product.updates') }}</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li><a href="#" class="text-white/70 hover:text-cyan transition-colors duration-300 text-sm font-medium">{{ __('landing.footer.resources.help') }}</a></li>
                    <li><a href="#" class="text-white/70 hover:text-cyan transition-colors duration-300 text-sm font-medium">{{ __('landing.footer.resources.docs') }}</a></li>
                    <li><a href="#" class="text-white/70 hover:text-cyan transition-colors duration-300 text-sm font-medium">{{ __('landing.footer.resources.blog') }}</a></li>
                    <li><a href="#" class="text-white/70 hover:text-cyan transition-colors duration-300 text-sm font-medium">{{ __('landing.footer.resources.api') }}</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li><a href="{{ route('privacy') }}" class="text-white/70 hover:text-cyan transition-colors duration-300 text-sm font-medium">{{ __('landing.footer.legal.privacy') }}</a></li>
                    <li><a href="{{ route('terms') }}" class="text-white/70 hover:text-cyan transition-colors duration-300 text-sm font-medium">{{ __('landing.footer.legal.terms') }}</a></li>
                    <li><a href="{{ route('cookies') }}" class="text-white/70 hover:text-cyan transition-colors duration-300 text-sm font-medium">{{ __('landing.footer.legal.cookie') }}</a></li>
                    <li><button onclick="openCookieSettings()" class="text-white/70 hover:text-cyan transition-colors duration-300 text-sm font-medium">{{ __('gdpr.banner.settings') }}</button></li>
                </ul>
            </div>
        </div>
