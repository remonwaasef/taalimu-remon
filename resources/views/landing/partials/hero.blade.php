...
<style>
    ...
    .hero-3d-side {
        transform:
            {{ app()->isLocale('ar') ? 'rotateY(8deg) rotateX(2deg)' : 'rotateY(-8deg) rotateX(2deg)' }}
            scale(1);
    ...
    @media (min-width: 1024px) {
        .hero-3d-side {
            transform:
                {{ app()->isLocale('ar') ? 'rotateY(12deg) rotateX(4deg)' : 'rotateY(-12deg) rotateX(4deg)' }}
                scale(0.98);
        }
    }
