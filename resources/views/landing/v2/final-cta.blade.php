<section id="cta" class="v2-section v2-final relative overflow-hidden !bg-slate-950 text-white" aria-labelledby="v2-final-title">
    ...
    <div class="v2-container relative z-10">
        <div class="text-center max-w-2xl mx-auto" data-reveal>
            <h2 id="v2-final-title" class="v2-h1 mb-4 text-white font-extrabold">{{ __('landing-v2.final.title') }}</h2>
            <p class="v2-lead mb-8 text-slate-300 text-base sm:text-lg">{{ __('landing-v2.final.subtitle') }}</p>

            <a href="{{ route('register') }}" data-track="v2_final_cta_clicked" class="v2-btn v2-btn-primary w-full sm:w-auto px-9 py-4 text-base sm:text-lg shadow-xl shadow-[rgba(46,139,131,0.4)] hover:shadow-2xl">
