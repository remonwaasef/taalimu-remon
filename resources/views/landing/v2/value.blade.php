<section id="value" class="v2-section" aria-labelledby="v2-value-title">
    <div class="v2-container">
        <div class="text-center max-w-2xl mx-auto mb-12 lg:mb-16" data-reveal>
            <span class="v2-eyebrow mb-4">{{ __('landing-v2.value.badge') }}</span>
        ...
        <div class="grid lg:grid-cols-5 gap-6 lg:gap-8 items-stretch">
            ...
            <article class="lg:col-span-3 v2-card p-7 lg:p-9 flex flex-col relative overflow-hidden" data-reveal>
                <div class="pointer-events-none absolute -top-20 -end-20 w-64 h-64 rounded-full blur-3xl" style="background: radial-gradient(closest-side, rgba(79,70,229,0.08), transparent);" aria-hidden="true"></div>
                ...
                <ul class="space-y-3 mt-auto">
                    @foreach(__('landing-v2.value.items.primary.points') as $point)
                        <li class="flex items-center gap-2.5 text-[13px] font-bold text-[color:var(--color-text-main)]">
                            <span class="w-5 h-5 rounded-full bg-[color:var(--color-primary-50)] text-[color:var(--color-primary-600)] flex items-center justify-center text-[9px] shrink-0"><i class="fas fa-check"></i></span>
                            {{ $point }}
                        </li>
                    @endforeach
                </ul>
                ...
                <div class="mt-7 flex items-center gap-3 rounded-xl bg-[color:var(--color-bg-main)] border border-[color:var(--color-border-subtle)] px-4 py-3">
                    <span class="w-9 h-9 rounded-lg bg-slate-900 text-white flex items-center justify-center"><i class="fas fa-qrcode"></i></span>
            ...
            <div class="lg:col-span-2 grid gap-6 lg:gap-8">
                <article class="v2-card p-7 flex flex-col" data-reveal style="--reveal-delay: 100ms;">
                ...
                <article class="v2-card p-7 flex flex-col" data-reveal style="--reveal-delay: 200ms;">
