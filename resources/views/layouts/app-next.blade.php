...
<body class="h-full bg-[#F8FAFC] dark:bg-[#0B1118] text-slate-900 dark:text-slate-100 {{ app()->getLocale() == 'ar' ? 'font-cairo' : 'font-inter' }} antialiased selection:bg-brand-primary selection:text-white transition-colors duration-200" x-data="{ sidebarOpen: false, collapsed: false }" x-effect="document.body.style.overflow = sidebarOpen ? 'hidden' : ''">

    <!-- Accessibility Skip to Main Content Link -->
    <a href="#main-content" class="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:start-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-brand-primary focus:text-white focus:rounded-[10px] focus:shadow-lg focus:font-bold">
