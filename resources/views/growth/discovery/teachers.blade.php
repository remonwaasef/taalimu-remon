...
<head>
    ...
    <title>{{ __('Discover Teachers') }} — Taalimu</title>
...
<body class="bg-slate-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-slate-900">{{ __('Discover Teachers') }}</h1>
            <p class="text-slate-500 mt-1">{{ __('Find the best teachers for your learning needs') }}</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="search" value="{{ $filters['search'] ?? '' }}"
                        ...
                        placeholder="{{ __('Teacher name or keyword...') }}">
                </div>
                <div>
        ...
        @else
            <div class="bg-white rounded-2xl shadow-sm p-12 text-center">
                ...
                <p class="text-slate-500">{{ __('No teachers found matching your criteria.') }}</p>
            </div>
        @endif
    </div>
