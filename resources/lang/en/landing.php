...
return [
    ...
    'hero' => [
        'badge' => 'The #1 Management System for Educational Centers in KSA',
        'title' => 'Manage Your Center <span class="text-primary-green">Smartly</span> & Save Hours of Work Weekly',
        'subtitle' => 'Integrated system for students, attendance, and payments — everything in one easy-to-use dashboard',
        'cta_primary' => 'Start for Free',
        'cta_secondary' => 'See How it Works',
        'cta_footer' => 'No credit card needed • 14-day free trial',
        'testimonial' => [
            'quote' => 'I saved over 15 hours a week after using Taalimu.',
            'author' => 'Ahmed Mohamed, Independent Teacher',
        ],
        'trust' => [
        ...
        'mockup' => [
            'whatsapp' => [
                ...
                'now' => 'now',
                'online' => 'Online',
                'message' => 'Hello Ahmed! 👋 Reminder: Your 150 SAR subscription is due tomorrow.',
                'cta' => 'Pay Now',
                'payment_received' => '150 SAR Payment Received',
                'payment_time' => '1 minute ago',
            ],
            'profit' => [
                'value' => '+38%',
