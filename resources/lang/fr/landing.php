...
return [
    'hero' => [
        ...
        'badge_new' => 'Le système le plus récent et le plus intelligent pour les centres éducatifs',
        ...
        'cta_demo' => 'Regarder une démo de 2 min',
        'check_setup' => 'Configuration en 2 min',
        'check_nocard' => 'Sans carte bancaire',
        'check_support' => 'Support continu',
        'check_trial' => 'Essai gratuit 14 jours',
        'pillar1_title' => '100%',
        'pillar1_sub' => 'Alertes WhatsApp automatisées',
        'pillar2_title' => 'Instantané',
        'pillar2_sub' => 'Présence par QR Code',
        'pillar3_title' => '14 jours',
        'pillar3_sub' => 'Essai gratuit complet',
        'card_whatsapp_title' => 'Notification aux Parents',
        'card_whatsapp_sub' => 'Facture envoyée automatiquement',
        'card_qr_title' => 'Présence par QR Code',
        'card_qr_sub' => 'Ahmed Ali - 09:00',
        'mockup' => [
            'whatsapp' => [
                'title' => 'WhatsApp',
                'now' => 'maintenant',
    ...
    'footer' => [
        ...
        'rights' => 'Tous droits réservés © '.date('Y'),
        'copyright' => 'Tous droits réservés © '.date('Y').' '.config('app.name').'.',
