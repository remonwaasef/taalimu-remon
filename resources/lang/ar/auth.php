...
return [
    ...
    'registration_steps' => [
        ...
        'fast_google_signup' => 'التسجيل السريع بضغطة زر',
        'fast_google_signup_subtitle' => 'ابدأ فوراً عبر حساب Google دون الحاجة لكلمة مرور',
        'fast_google_badge' => 'تفعيل فوري • بدون كلمة مرور',
        'google_button_label' => 'المتابعة السريعة بحساب Google',
        'or_manual_registration' => 'أو التسجيل اليدوي بالبريد الإلكتروني (خطوتان)',
        'manual_step1_badge' => 'الخطوة 1: تحديد اسم ورابط المنصة',
        'next_manual_step2' => 'متابعة التسجيل اليدوي — البيانات الشخصية',
        'manual_step2_title' => 'الخطوة 2 من 2: بيانات الحساب وكلمة المرور',
        'prefer_google' => 'تفضل التسجيل السريع؟',
        'signup_with_google_link' => 'سجّل بنقرة واحدة عبر Google',
