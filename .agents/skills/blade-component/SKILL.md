...
|---|---|---|---|
| `--primary-500` | `#5B5FEF` | `#5B5FEF` | اللون الأساسي (Taalimu Indigo) |
| `--primary-600` | `#4548C7` | `#4548C7` | Hover (Indigo Dark) |
| `--primary-700` | `#3A3CA8` | `#3A3CA8` | Active/Pressed |
| `--bg` | `#F8FAFC` | `#0F1720` | خلفية الصفحة (Taalimu Snow) |
| `--surface` | `#FFFFFF` | `#17202B` | سطح البطاقات |
| `--card` | `#FFFFFF` | `#1D2935` | خلفية البطاقة |
| `--border` | `#E2E8F0` | `#2B3644` | الحدود |
| `--text-primary` | `#111827` | `#F9FAFB` | النص الرئيسي |
| `--text-secondary` | `#475569` | `#CBD5E1` | النص الثانوي |
| `--success` | `#16A34A` | `#16A34A` | نجاح |
| `--warning` | `#D97706` | `#D97706` | تحذير |
| `--error` | `#DC2626` | `#DC2626` | خطأ |
| `--info` | `#0284C7` | `#0284C7` | معلومات |
...
- **70% ألوان محايدة (Neutral)** — Snow `#F8FAFC`, Borders `#E2E8F0`
- **20% أسطح بيضاء (Surface/Cards)** — `#FFFFFF`
- **10% ألوان العلامة التجارية والحالات** — Taalimu Indigo `#5B5FEF` للعناصر المهمة فقط
- **المسافات البيضاء جزء من التصميم** — لا تزدحم العناصر (نظام المسافات 4px)
- **ظلال خفيفة وناعمة جداً** — `0 2px 8px rgba(15,23,42,0.06)` — لا تستخدم ظلال ثقيلة
- **حدود مستديرة (Border Radius)**: بطاقات `16px`، أزرار ومدخلات `10px`، شارات `9999px`، نوافذ `20px`
