    ...
    public function run(): void
    {
        ...
        $plans = [
            ...
            [
                ...
                'is_featured' => false,
                'regional_prices' => [
                    'default' => ['amount' => 29, 'currency' => 'USD'],
                    'EG' => ['amount' => 250, 'currency' => 'EGP'],
                    'SA' => ['amount' => 99, 'currency' => 'SAR'],
                    'AE' => ['amount' => 99, 'currency' => 'AED'],
                    'FR' => ['amount' => 29, 'currency' => 'EUR'],
                ],
                'features' => [
                    'max_students' => '150',
                    'max_instructors' => '1',
            ...
            [
                ...
                'regional_prices' => [
                    'default' => ['amount' => 59, 'currency' => 'USD'],
                    'EG' => ['amount' => 600, 'currency' => 'EGP'],
                    'SA' => ['amount' => 199, 'currency' => 'SAR'],
                    'AE' => ['amount' => 199, 'currency' => 'AED'],
                    'FR' => ['amount' => 59, 'currency' => 'EUR'],
                ],
                'features' => [
                    'max_students' => '500',
                    'max_instructors' => '10',
            ...
            [
                ...
                'is_featured' => false,
                'regional_prices' => [
                    'default' => ['amount' => 149, 'currency' => 'USD'],
                    'EG' => ['amount' => 1500, 'currency' => 'EGP'],
                    'SA' => ['amount' => 499, 'currency' => 'SAR'],
                    'AE' => ['amount' => 499, 'currency' => 'AED'],
                    'FR' => ['amount' => 149, 'currency' => 'EUR'],
                ],
                'features' => [
                    'max_students' => '-1',
                    'max_instructors' => '-1',
