...
@section('content')
    ...
    <!-- Children Cards -->
    <x-ui.card title="أبنائي ðŸ“š" subtitle="حالة كل ابن وأهم مؤشرات المتابعة" class="mb-8">
        @if($children->count() > 0)
                        ...
                        <div class="p-5">
                            ...
                            <div class="grid grid-cols-2 gap-2 mb-4">
                                <div class="rounded-xl bg-slate-50 dark:bg-slate-800/60 p-3 text-center">
                                    ...
                                    <div class="text-[11px] text-slate-400 font-semibold">دورات</div>
                                </div>
                                <div class="rounded-xl bg-slate-50 dark:bg-slate-800/60 p-3 text-center">
                                    ...
                                    @endif
                                    <div class="text-[11px] text-slate-400 font-semibold">حضور</div>
                                </div>
                            </div>
