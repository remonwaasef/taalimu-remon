...
@section('sidebar')
    <x-ui.sidebar brandName="Taalimu">
        <div class="space-y-1">
            ...
            <a href="{{ route('instructor.students.list') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold text-brand-primary bg-brand-50 dark:bg-brand-900/30">
