...
<x-ui.sidebar brandName="Taalimu">
    <div class="space-y-1">
        ...
        <div class="pt-4 pb-1 px-3 text-[10px] font-bold text-slate-400 uppercase tracking-wider">{{ __('instructor::sidebar.teaching') ?? 'Teaching' }}</div>
        ...
        <div class="pt-4 pb-1 px-3 text-[10px] font-bold text-slate-400 uppercase tracking-wider">{{ __('instructor::sidebar.account') ?? 'Account' }}</div>
