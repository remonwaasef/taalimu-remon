...
@section('title', __('instructor::groups.edit_title') ?? 'Edit Group')
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text rounded-end-3 bg-light border-start-0">{{ app('tenant')->settings['currency'] ?? 'EGP' }}</span>
                                </div>
                                @error('price')
