                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="platform" id="platformSelect" class="form-select rounded-pill px-3 @error('platform') is-invalid @enderror" required>
                                    <option value="manual" {{ old('platform', ($zoomConfigured ?? false) ? 'zoom' : 'manual') == 'manual' ? 'selected' : '' }}>
                                        رابط مباشر (Google Meet, Zoom خارجي, Teams) {{ !($zoomConfigured ?? false) ? '— (موصى به)' : '' }}
                                    </option>
                                    <option value="zoom" {{ old('platform', ($zoomConfigured ?? false) ? 'zoom' : 'manual') == 'zoom' ? 'selected' : '' }}>
