...
@section('title', 'كشف حساب المدرس: ' . $instructor->name)
        ...
        <div class="row g-3 mb-5 px-3">
            <div class="col-md-4">
                <div class="bg-light rounded-3 p-3 text-center border">
                    <small class="text-muted d-block mb-1">إجمالي العمولات (دائن)</small>
                    <h5 class="fw-bold text-success mb-0">{{ format_price($ledger->where('is_credit', true)->sum('amount')) }}</h5>
                </div>
            </div>
            <div class="col-md-4">
                <div class="bg-light rounded-3 p-3 text-center border">
                    <small class="text-muted d-block mb-1">إجمالي المنصرف (مدين)</small>
            ...
            <div class="col-md-4">
                <div class="bg-primary bg-opacity-10 rounded-3 p-3 text-center border border-primary border-opacity-25">
                    <small class="text-primary fw-bold d-block mb-1">الرصيد الحالي</small>
            ...
            <table class="table align-middle table-bordered mb-0">
                <thead class="bg-light">
                    <tr>
                        ...
                        <th class="text-center bg-light fw-bold">الرصيد</th>
                    </tr>
                </thead>
                <tbody>
                    @php $i = 1; @endphp
