                ...
                @if($hasFinancialReports || $hasAdvancedReports)
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse {{ $isFinanceActive ? 'show' : '' }}" id="financeCollapse" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item"><a class="nav-link {{ request()->routeIs('center.analytics.profit_loss') ? 'active' : '' }}" href="{{ route('center.analytics.profit_loss') }}"><i class="sidenav-mini-icon">P</i><span class="item-name">{{ __('center::analytics.profit_loss_report') }}</span></a></li>
