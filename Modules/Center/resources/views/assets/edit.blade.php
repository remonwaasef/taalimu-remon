        ...
        <div class="col-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active text-primary" aria-current="page">{{ isset($asset) ? __('center::messages.blade_0196') : __('center::messages.blade_0197') }}</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="card-body p-4">
            <form action="{{ isset($asset) ? route('center.assets.update', $asset) : route('center.assets.store') }}" method="POST">
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary px-5 rounded-pill shadow-sm fw-bold">{{ __('center::messages.blade_0194') }}</button>
                    <a href="{{ route('center.assets.index') }}" class="btn btn-light px-4 rounded-pill border">{{ __('center::messages.blade_0195') }}</a>
                </div>
            </form>
        </div>
    </div>
