...
<div class="row">
                ...
                <form action="{{ route('center.expenses.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="category" class="form-control rounded-pill @error('category') is-invalid @enderror" placeholder="مثلاً: إيجار، رواتب، كهرباء" value="{{ old('category') }}">
                            @error('category')
    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm rounded-4 bg-primary text-white p-2">
            <div class="card-body">
                <h5 class="fw-bold mb-3"><i class="fas fa-info-circle me-2"></i>معلومة</h5>
