...
@section('title', __('center::messages.blade_0066'))

@section('content')
<div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-1 text-gray-800 fw-bold">{{ __('center::messages.blade_0045') }}</h1>
            <p class="text-muted mb-0">{{ __('center::messages.blade_0046') }}</p>
        </div>
        <div>
            ...
            <div class="card border-0 shadow-sm h-100 py-2 rounded-4 border-start border-4 border-primary">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col me-2">
                            <div class="text-xs fw-bold text-primary text-uppercase mb-1">{{ __('center::messages.blade_0047') }}</div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card border-0 shadow-sm h-100 py-2 rounded-4 border-start border-4 border-info">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col me-2">
                            <div class="text-xs fw-bold text-info text-uppercase mb-1">{{ __('center::messages.blade_0049') }}</div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-white border-0 rounded-top-4">
                    <h6 class="m-0 fw-bold text-primary">{{ __('center::messages.blade_0051') }}</h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-white border-0 rounded-top-4">
                    <h6 class="m-0 fw-bold text-primary">{{ __('center::messages.blade_0052') }}</h6>
                </div>
                <div class="card-body">
                    ...
                    <div class="mt-3 text-center small d-flex justify-content-center gap-3">
                        <span class="mr-2"><i class="fas fa-circle text-success big-dot"></i>{{ __('center::messages.blade_0053') }}</span>
                        <span class="mr-2"><i class="fas fa-circle text-warning big-dot"></i>{{ __('center::messages.blade_0054') }}</span>
                        <span class="mr-2"><i class="fas fa-circle text-danger big-dot"></i>{{ __('center::messages.blade_0055') }}</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-header py-3 bg-white border-0 rounded-top-4">
                    <h6 class="m-0 fw-bold text-primary">{{ __('center::messages.blade_0056') }}</h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm rounded-4 h-100">
                <div class="card-header py-3 bg-white border-0 rounded-top-4">
                    <h6 class="m-0 fw-bold text-primary">{{ __('center::messages.blade_0057') }}</h6>
                </div>
                <div class="card-body">
                    <div class="chart-bar" style="height: 300px;">
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
        <div class="card-header py-3 bg-white border-0 rounded-top-4">
            <h6 class="m-0 fw-bold text-primary">{{ __('center::messages.blade_0058') }}</h6>
        </div>
            ...
            <div class="table-responsive">
                <table class="table align-middle mb-0 table-hover">
                    <thead class="bg-light">
                        <tr>
                            <th class="border-0 p-3">{{ __('center::messages.blade_0059') }}</th>
                            <th class="border-0 p-3">{{ __('center::messages.blade_0060') }}</th>
                            <th class="border-0 p-3">{{ __('center::messages.blade_0061') }}</th>
                            <th class="border-0 p-3">{{ __('center::messages.blade_0062') }}</th>
                            <th class="border-0 p-3">{{ __('center::messages.blade_0063') }}</th>
                            <th class="border-0 p-3">{{ __('center::messages.blade_0064') }}</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-5 text-muted">{{ __('center::messages.blade_0065') }}</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
