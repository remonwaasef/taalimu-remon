        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm border-0 rounded-4 mb-4">
                <div class="card-header bg-white border-0 pt-4 px-4">
                    ...
                    <p class="text-muted small mb-0">تحديث البيانات الشخصية وكلمة المرور الخاصة بك</p>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('center.profile.update') }}" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label fw-bold small text-muted">الاسم بالكامل</label>
                            ...
                            <h6 class="fw-bold text-dark mb-3">
                                <i class="fas fa-lock me-2 text-warning"></i>تغيير كلمة المرور
                            </h6>
                            <div class="col-md-6">
            ...
            <div class="card shadow-sm border-0 rounded-4">
                <div class="card-header bg-white border-0 pt-4 px-4">
                    <h5 class="fw-bold text-dark mb-0">
                        <i class="fas fa-globe me-2 text-info"></i>لغة النظام
                    </h5>
                    <p class="text-muted small mb-0">اختر لغتك المفضلة لعرض لوحة التحكم</p>
                </div>
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-md-4">
