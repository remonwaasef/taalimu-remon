...
@section('panel-content')
    ...
    <div class="mb-8 font-inter">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <a href="{{ route('center.students.create', ['tenant' => $tenant->domain ?? app('tenant')?->domain]) }}" class="p-4.5 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-brand-primary/40 dark:hover:border-brand-primary/40 hover:shadow-md transition-all duration-200 flex flex-col items-center justify-center group text-center shadow-xs">
                <div class="w-11 h-11 rounded-xl bg-brand-50 dark:bg-brand-900/30 text-brand-primary dark:text-brand-300 flex items-center justify-center text-lg mb-2.5 group-hover:scale-110 transition-transform">
