...
<div class="container text-center mt-5">
    <div class="card shadow-lg border-0 rounded-4 mx-auto" style="max-width: 500px;">
        <div class="card-header bg-primary text-white p-4">
            <h3 class="fw-bold mb-1"><i class="bi bi-qr-code-scan me-2"></i>مسح رمز الحضور</h3>
        ...
        <div class="card-body p-5">
            ...
            <div class="alert alert-light border-0 small text-muted">
                <i class="bi bi-info-circle me-1"></i> يتم تحديث الرمز تلقائياً كل دقيقة لضمان الأمان.
            </div>
