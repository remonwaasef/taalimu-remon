        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="tab-content" id="settingsTabsContent">
                        <!-- General Settings -->
                        @include('center::settings.partials._tab-general')
                        @include('center::settings.partials._tab-reminders')
                        @include('center::settings.partials._tab-academic')
                        @include('center::settings.partials._tab-financial')
                        @include('center::settings.partials._tab-appearance')
                        @include('center::settings.partials._tab-whatsapp')
                        @include('center::settings.partials._tab-privacy')
    </div>
</div>
@endsection
