...
<div class="container-fluid p-0">
    <div class="mb-4">
        ...
        <h4 class="fw-bold mt-2">{{ __('center::questions.create_title') }}</h4>
    </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-body p-4">
                        <div class="mb-4">
                            ...
                            <textarea name="content" class="form-control rounded-4" rows="4" placeholder="{{ __('center::questions.content_placeholder') }}" required></textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div id="optionsContainer">
                                <div class="option-row mb-3 d-flex gap-3 align-items-center">
                                    ...
                                    <input type="text" name="options[0][content]" class="form-control rounded-pill" placeholder="{{ __('center::questions.option_1') }}" required>
                                </div>
                                <div class="option-row mb-3 d-flex gap-3 align-items-center">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="correct_option" value="1">
                                    </div>
                                    <input type="text" name="options[1][content]" class="form-control rounded-pill" placeholder="{{ __('center::questions.option_2') }}" required>
                                </div>
                            </div>
                            <button type="button" class="btn btn-outline-primary btn-sm rounded-pill px-3 mt-2" onclick="addOption()">
                                <i class="fas fa-plus me-1"></i>{{ __('center::questions.add_option') }}</button>
                        </div>

                        <div class="mb-0">
                            <label class="form-label fw-bold">{{ __('center::questions.explanation') }}</label>
                            <textarea name="explanation" class="form-control rounded-4" rows="2" placeholder="{{ __('center::questions.explanation_placeholder') }}"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="difficulty" class="form-select rounded-pill">
                                <option value="easy">{{ __('center::questions.easy') }}</option>
                                <option value="medium" selected>{{ __('center::questions.medium') }}</option>
                                <option value="hard">{{ __('center::questions.hard') }}</option>
                            </select>
                        </div>
...
<script>
    ...
    function addOption() {
        ...
        div.innerHTML = `
            ...
            <input type="text" name="options[${optionCount}][content]" class="form-control rounded-pill" placeholder="{{ __('center::questions.option_placeholder') }}" required>
        ...
        if (type === 'true_false') {
            container.innerHTML = `
                <div class="option-row mb-3 d-flex gap-3 align-items-center">
                    ...
                    <input type="text" name="options[0][content]" class="form-control rounded-pill" value="{{ __('center::questions.true') }}" readonly>
                </div>
                <div class="option-row mb-3 d-flex gap-3 align-items-center">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="correct_option" value="1">
                    </div>
                    <input type="text" name="options[1][content]" class="form-control rounded-pill" value="{{ __('center::questions.false') }}" readonly>
                </div>
            `;
