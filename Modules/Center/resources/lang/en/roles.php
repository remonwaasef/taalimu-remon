...
return [
    ...
    'start_from_preset' => 'Start from a Ready Template (Sub-roles)',
    'preset_accountant' => 'Accountant',
    'preset_secretary' => 'Secretary / Reception',
    'preset_cashier' => 'Cashier',
    'preset_staff' => 'General Staff',
    'accountant_sub_suggestion' => 'Junior Accountant',
    'secretary_sub_suggestion' => 'Reception Secretary',
    'cashier_sub_suggestion' => 'Cashier Clerk',
    'staff_sub_suggestion' => 'General Staff',
    'apply_preset' => 'Apply this template to the permissions',
    'preset_help' => 'Pick a template to auto-check the suggested permissions, then adjust them as needed. Templates do not create the role — submit after reviewing the name and permissions.',
    'search_permissions' => 'Search permissions...',
    'selected_permissions' => 'selected permissions',
    'permission_search_help' => 'Quick filter over the available center-scope permissions',
];
