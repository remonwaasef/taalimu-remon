...
@section('sidebar')
    <x-ui.sidebar brandName="Student Campus">
        <div class="space-y-1">
            ...
            <a href="{{ route('campus.courses.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold text-brand-primary bg-brand-50 dark:bg-brand-900/30">
