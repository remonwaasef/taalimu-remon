...
@section('title', __('admin.roles.create_new'))
@section('page-title', __('admin.roles.create_new'))
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control rounded-end-3 shadow-none border @error('name') is-invalid @enderror" required value="{{ old('name') }}" placeholder="مثال: accountant">
                            </div>
                            @error('name')
                        ...
                        <div class="col-md-6 text-md-end mt-3 mt-md-0">
                            <button type="submit" class="btn btn-primary rounded-pill px-4 me-2">
                                <i class="fas fa-plus me-2"></i> {{ __('admin.save_changes') }}
                            </button>
                                ...
                                <div class="d-flex flex-column gap-2">
                                    @foreach($perms as $permission)
                                        <div class="form-check form-switch custom-switch p-0 d-flex justify-content-between align-items-center flex-row-reverse">
                                            <input class="form-check-input ms-0" type="checkbox" id="perm_{{ $permission->id }}" name="permissions[]" value="{{ $permission->name }}">
