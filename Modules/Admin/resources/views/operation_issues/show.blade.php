...
<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.operation-issues.index') }}">Operation Issues</a></li>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="statusDropdown">
                    <form action="{{ route('admin.operation-issues.update-status', $issue->uuid) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <button class="dropdown-item" type="submit" name="status" value="in_progress">In Progress</button>
                        <button class="dropdown-item" type="submit" name="status" value="resolved">Resolved</button>
                        <button class="dropdown-item" type="submit" name="status" value="closed">Closed</button>
                        <div class="dropdown-divider"></div>
                        <button class="dropdown-item" type="submit" name="status" value="wont_fix">Won't Fix</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm">
                            <tbody>
                                <tr>
                                    <th width="150" class="bg-light">Action</th>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $issue->user->name ?? 'Guest' }} ({{ $issue->user->email ?? '-' }})</td>
                                </tr>
                                <tr>
                                    <th class="bg-light">IP / User Agent</th>
                                    <td>
                    ...
                    <div class="mt-4">
                        <h6 class="font-weight-bold">Error Message</h6>
                    ...
                    <div class="mt-4">
                        <h6 class="font-weight-bold">Stack Trace</h6>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">History & Comments</h6>
                </div>
                <div class="card-body">
                    <div class="timeline">
                        ...
                        <div class="pb-3 mb-3 border-bottom">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <span class="font-weight-bold">{{ $activity->user->name ?? 'System' }}</span>
                    ...
                    <form action="{{ route('admin.operation-issues.comments', $issue->uuid) }}" method="POST" class="mt-4">
                        ...
                        <div class="form-group">
                            <textarea name="comment" class="form-control" rows="3" placeholder="Add a note or comment..."></textarea>
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    @else
                    <div class="alert alert-light text-center">Unassigned</div>
                    @endif
                    ...
                    <form action="{{ route('admin.operation-issues.assign', $issue->uuid) }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-outline-primary btn-block btn-sm">Assign</button>
                    </form>
                </div>
            </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">SLA Tracker</h6>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <small class="text-muted d-block">Time Open</small>
                        <strong class="h5">{{ $issue->created_at->diffForHumans(null, true) }}</strong>
                    </div>
                    
                    @if($issue->resolved_at)
                    <div class="mb-3">
                        <small class="text-muted d-block">Time to Resolution</small>
                        <strong>{{ $issue->resolution_time_minutes }} mins</strong>
                    </div>
                    @endif
