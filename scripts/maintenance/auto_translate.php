...
if (! is_dir("$baseDir/ar")) {
    mkdir("$baseDir/ar", 0777, true);
}
if (! is_dir("$baseDir/en")) {
    mkdir("$baseDir/en", 0777, true);
}
if (! is_dir("$baseDir/fr")) {
    mkdir("$baseDir/fr", 0777, true);
}
