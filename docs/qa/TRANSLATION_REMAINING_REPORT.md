...
Generated at: 2026-09-03 01:06:38

## Summary

- **Total Languages:** 2
- **Total Translation Files:** 136
- **Total Referenced Keys:** 2798
- **Total Missing Keys:** 4798
- **Total Unused Keys:** 8612
- **Total Hardcoded Strings:** 245
...
| `resources\views\design-system\index.blade.php` | `Badges` |
| `resources\views\design-system\index.blade.php` | `Alerts` |
| `resources\views\design-system\index.blade.php` | `Product UI Examples` |
| `resources\views\design-system\index.blade.php` | `Taalimu Dark Preview` |
| `resources\views\design-system\index.blade.php` | `RTL First` |
| `resources\views\design-system\index.blade.php` | `Accessible` |
| `resources\views\design-system\index.blade.php` | `Responsive` |
| `resources\views\design-system\index.blade.php` | `Consistent` |
| `resources\views\design-system\index.blade.php` | `Scalable` |
