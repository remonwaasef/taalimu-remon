...
class TenantOnboardingMail extends Mailable implements ShouldQueue
{
    ...
    {
        $subjects = [
            1 => "{$this->user->name}, votre centre est prÃªt sur Taalimu ! VÃ©rifiez votre email",
            2 => "{$this->user->name}, 80% des centres ajoutent leurs Ã©lÃ¨ves dÃ¨s le J1 ðŸ“Š",
            3 => 'ArrÃªtez de courir aprÃ¨s les paiements ! Automatisez avec Taalimu',
            4 => 'Fini les appels sans fin ! Activez votre portail parents',
            5 => 'Comment Centre Y gÃ¨re 500 Ã©lÃ¨ves sans stress avec Taalimu',
        ];
